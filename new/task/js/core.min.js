...
!function(t, e) {
    ...
    function w(t, e, i) {
        var n, o, s = (i = i || x).createElement("script");
        if (s.text = t,
        e)
            for (n in u)
    ...
    function d(t) {
        var e = !!t && "length"in t && t.length
          , i = _(t);
        return !y(t) && !f(t) && ("array" === i || 0 === e || "number" == typeof e && 0 < e && e - 1 in t)
    }
    C.fn = C.prototype = {
        jquery: h,
        constructor: C,
    ...
    C.extend = C.fn.extend = function() {
        ...
        a--); a < l; a++)
            if (null != (t = arguments[a]))
                for (e in t)
                    n = t[e],
                    "__proto__" !== e && r !== n && (c && n && (C.isPlainObject(n) || (o = Array.isArray(n))) ? (i = r[e],
                    s = o && !Array.isArray(i) ? [] : o || C.isPlainObject(i) ? i : {},
                    o = !1,
                    r[e] = C.extend(c, s, n)) : void 0 !== n && (r[e] = n));
        return r
    }
    ,
    C.extend({
        ...
        isPlainObject: function(t) {
            var e, i;
            return !(!t || "[object Object]" !== s.call(t) || (e = n(t)) && ("function" != typeof (i = m.call(e, "constructor") && e.constructor) || r.call(i) !== c))
        },
    ...
    var p = function(i) {
        ...
        var t, p, w, s, r, A, d, f, _, l, c, b, E, a, x, g, u, m, v, C = "sizzle" + +new Date, y = i.document, T = 0, n = 0, D = lt(), P = lt(), S = lt(), I = lt(), k = function(t, e) {
            return t === e && (c = !0),
            0
        }, B = {}.hasOwnProperty, e = [], z = e.pop, N = e.push, O = e.push, R = e.slice, Q = function(t, e) {
            for (var i = 0, n = t.length; i < n; i++)
                if (t[i] === e)
                    return i;
            return -1
        }, M = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", L = "[\\x20\\t\\r\\n\\f]", j = "(?:\\\\[\\da-fA-F]{1,6}" + L + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", q = "\\[" + L + "*(" + j + ")(?:" + L + "*([*^$|!~]?=)" + L + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + j + "))|)" + L + "*\\]", H = ":(" + j + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + q + ")*)|.*)\\)|)", F = new RegExp(L + "+","g"), W = new RegExp("^" + L + "+|((?:^|[^\\\\])(?:\\\\.)*)" + L + "+$","g"), V = new RegExp("^" + L + "*," + L + "*"), U = new RegExp("^" + L + "*([>+~]|" + L + ")" + L + "*"), Y = new RegExp(L + "|>"), Z = new RegExp(H), G = new RegExp("^" + j + "$"), $ = {
            ID: new RegExp("^#(" + j + ")"),
            CLASS: new RegExp("^\\.(" + j + ")"),
            TAG: new RegExp("^(" + j + "|[*])"),
            ATTR: new RegExp("^" + q),
        ...
        }, X = /HTML$/i, J = /^(?:input|select|textarea|button)$/i, K = /^h\d$/i, tt = /^[^{]+\{\s*\[native \w/, et = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, it = /[+~]/, nt = new RegExp("\\\\[\\da-fA-F]{1,6}" + L + "?|\\\\([^\\r\\n\\f])","g"), ot = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, st = function(t, e) {
        ...
        try {
            O.apply(e = R.call(y.childNodes), y.childNodes),
        ...
        function at(t, e, i, n) {
            var o, s, r, a, l, c, u, h = e && e.ownerDocument, d = e ? e.nodeType : 9;
            if (i = i || [],
            ...
            x)) {
                    ...
                    if (o = l[1]) {
                        if (9 === d) {
                            ...
                            if (r.id === o)
                                return i.push(r),
                                i
                        } else if (h && (r = h.getElementById(o)) && v(e, r) && r.id === o)
                            return i.push(r),
                            i
                    } else {
                        if (l[2])
                ...
                if (p.qsa && !I[t + " "] && (!g || !g.test(t)) && (1 !== d || "object" !== e.nodeName.toLowerCase())) {
                    if (u = t,
                    h = e,
                    1 === d && (Y.test(t) || U.test(t))) {
                        for ((h = it.test(t) && ft(e.parentNode) || e) === e && p.scope || ((a = e.getAttribute("id")) ? a = a.replace(ot, st) : e.setAttribute("id", a = C)),
                        s = (c = A(t)).length; s--; )
                            c[s] = (a ? "#" + a : ":scope") + " " + mt(c[s]);
                        u = c.join(",")
                    }
                    try {
                        return O.apply(i, h.querySelectorAll(u)),
                        i
                    } catch (e) {
                        I(t, !0)
                    } finally {
        ...
        ,
        b = at.setDocument = function(t) {
            var e, i, n = t ? t.ownerDocument || t : y;
            return n != E && 9 === n.nodeType && n.documentElement && (a = (E = n).documentElement,
            x = !r(E),
            y != E && (i = E.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", o, !1) : i.attachEvent && i.attachEvent("onunload", o)),
            p.scope = ut(function(t) {
                return a.appendChild(t).appendChild(E.createElement("div")),
            ...
            p.getElementsByClassName = tt.test(E.getElementsByClassName),
            p.getById = ut(function(t) {
                return a.appendChild(t).id = C,
            ...
            u = [],
            g = [],
            (p.qsa = tt.test(E.querySelectorAll)) && (ut(function(t) {
                var e;
                ...
                t.querySelectorAll("[selected]").length || g.push("\\[" + L + "*(?:value|" + M + ")"),
            ...
            v = e || tt.test(a.contains) ? function(t, e) {
            ...
            k = e ? function(t, e) {
                ...
                return i || (1 & (i = (t.ownerDocument || t) == (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !p.sortDetached && e.compareDocumentPosition(t) === i ? t == E || t.ownerDocument == y && v(y, t) ? -1 : e == E || e.ownerDocument == y && v(y, e) ? 1 : l ? Q(l, t) - Q(l, e) : 0 : 4 & i ? -1 : 1)
            }
            : function(t, e) {
                if (t === e)
                    return c = !0,
                ...
                if (!o || !s)
                    return t == E ? -1 : e == E ? 1 : o ? -1 : s ? 1 : l ? Q(l, t) - Q(l, e) : 0;
                if (o === s)
                    return dt(t, e);
        ...
        at.matchesSelector = function(t, e) {
            if (b(t),
            p.matchesSelector && x && !I[e + " "] && (!u || !u.test(e)) && (!g || !g.test(e)))
                try {
                    var i = m.call(t, e);
        ...
        at.contains = function(t, e) {
            return (t.ownerDocument || t) != E && b(t),
            v(t, e)
        }
        ,
        at.attr = function(t, e) {
            (t.ownerDocument || t) != E && b(t);
            var i = w.attrHandle[e.toLowerCase()]
              , n = i && B.call(w.attrHandle, e.toLowerCase()) ? i(t, e, !x) : void 0;
            return void 0 !== n ? n : p.attributes || !x ? t.getAttribute(e) : (n = t.getAttributeNode(e)) && n.specified ? n.value : null
        }
        ,
        ...
        (w = at.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, i = !t[6] && t[2];
                    return $.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && Z.test(i) && (e = A(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e),
                    t[2] = i.slice(0, e)),
                    t.slice(0, 3))
                }
            },
            filter: {
                ...
                ATTR: function(i, n, o) {
                    return function(t) {
                        var e = at.attr(t, i);
                        return null == e ? "!=" === n : !n || (e += "",
                        "=" === n ? e === o : "!=" === n ? e !== o : "^=" === n ? o && 0 === e.indexOf(o) : "*=" === n ? o && -1 < e.indexOf(o) : "$=" === n ? o && e.slice(-o.length) === o : "~=" === n ? -1 < (" " + e.replace(F, " ") + " ").indexOf(o) : "|=" === n && (e === o || e.slice(0, o.length + 1) === o + "-"))
                    }
                },
                CHILD: function(A, t, e, f, g) {
                    ...
                    : function(t, e, i) {
                        var n, o, s, r, a, l, c = m != v ? "nextSibling" : "previousSibling", u = t.parentNode, h = y && t.nodeName.toLowerCase(), d = !i && !y, p = !1;
                        if (u) {
                            if (m) {
                                for (; c; ) {
                                    for (r = t; r = r[c]; )
                                        if (y ? r.nodeName.toLowerCase() === h : 1 === r.nodeType)
                                            return !1;
                            ...
                            v && d) {
                                for (p = (a = (n = (o = (s = (r = u)[C] || (r[C] = {}))[r.uniqueID] || (s[r.uniqueID] = {}))[A] || [])[0] === T && n[1]) && n[2],
                                r = a && u.childNodes[a]; r = ++a && r && r[c] || (p = a = 0) || l.pop(); )
                                    if (1 === r.nodeType && ++p && r === t) {
                                        o[A] = [T, a, p];
                                        break
                                    }
                            } else if (d && (p = a = (n = (o = (s = (r = t)[C] || (r[C] = {}))[r.uniqueID] || (s[r.uniqueID] = {}))[A] || [])[0] === T && n[1]),
                            !1 === p)
                                for (; (r = ++a && r && r[c] || (p = a = 0) || l.pop()) && ((y ? r.nodeName.toLowerCase() !== h : 1 !== r.nodeType) || !++p || (d && ((o = (s = r[C] || (r[C] = {}))[r.uniqueID] || (s[r.uniqueID] = {}))[A] = [T, p]),
                                r !== t)); )
                                    ;
                ...
                PSEUDO: function(t, s) {
                    ...
                    return r[C] ? r(s) : 1 < r.length ? (e = [t, t, "", s],
                    w.setFilters.hasOwnProperty(t.toLowerCase()) ? ct(function(t, e) {
            ...
            pseudos: {
                not: ct(function(t) {
                    var n = []
                      , o = []
                      , a = d(t.replace(W, "$1"));
                    return a[C] ? ct(function(t, e, i, n) {
                ...
                lang: ct(function(i) {
                    return G.test(i || "") || at.error("unsupported lang: " + i),
                    i = i.replace(nt, h).toLowerCase(),
                    function(t) {
                        var e;
                        do {
                            if (e = x ? t.lang : t.getAttribute("xml:lang") || t.getAttribute("lang"))
        ...
        function vt(a, t, e) {
            ...
            : function(t, e, i) {
                ...
                if (i) {
                    ...
                    for (; t = t[l]; )
                        if (1 === t.nodeType || h)
                            if (o = (s = t[C] || (t[C] = {}))[t.uniqueID] || (s[t.uniqueID] = {}),
        ...
        function _t(t) {
            for (var o, e, i, n = t.length, s = w.relative[t[0].type], r = s || w.relative[" "], a = s ? 1 : 0, l = vt(function(t) {
                return t === o
            }, r, !0), c = vt(function(t) {
                return -1 < Q(o, t)
            }, r, !0), u = [function(t, e, i) {
                var n = !s && (i || e !== _) || ((o = e).nodeType ? l : c)(t, e, i);
                return o = null,
                n
            }
            ]; a < n; a++)
                            ...
                            ct(function(t, e, i, n) {
                                var o, s, r, a = [], l = [], c = e.length, u = t || function(t, e, i) {
                                    for (var n = 0, o = e.length; n < o; n++)
                                        at(t, e[n], i);
                                    return i
                                }(A || "*", i.nodeType ? [i] : i, []), h = !p || !t && A ? u : wt(u, a, p, i, n), d = f ? m || (t ? p : c || g) ? [] : e : h;
                                if (f && f(h, d, i, n),
                                g)
                                    for (o = wt(d, l),
                                    g(o, [], i, n),
                                ...
                                if (t) {
                                    if (m || p) {
                                        ...
                                        for (s = d.length; s--; )
                                            (r = d[s]) && -1 < (o = m ? Q(t, r) : a[s]) && (t[o] = !(e[o] = r))
                                    }
                                } else
                                    d = wt(d === e ? d.splice(c, d.length) : d),
                                    m ? m(null, e, d, n) : O.apply(e, d)
                            })
                        }(1 < a && yt(u), 1 < a && mt(t.slice(0, a - 1).concat({
                            value: " " === t[a - 2].type ? "*" : ""
                        })).replace(W, "$1"), e, a < i && _t(t.slice(a, i)), i < n && _t(t = t.slice(i)), i < n && mt(t))
                    }
                    u.push(e)
                }
            return yt(u)
        ...
        A = at.tokenize = function(t, e) {
            ...
            a = [],
            l = w.preFilter; r; ) {
                for (s in i && !(n = V.exec(r)) || (n && (r = r.slice(n[0].length) || r),
                a.push(o = [])),
                i = !1,
                (n = U.exec(r)) && (i = n.shift(),
                o.push({
                    value: i,
                    type: n[0].replace(W, " ")
                }),
                r = r.slice(i.length)),
                w.filter)
                    !(n = $[s].exec(r)) || l[s] && !(n = l[s](n)) || (i = n.shift(),
                    o.push({
                        value: i,
                        type: s,
                        matches: n
        ...
        d = at.compile = function(t, e) {
            var i, g, m, v, y, n, o = [], s = [], r = S[t + " "];
            if (!r) {
                for (i = (e = e || A(t)).length; i--; )
                    (r = _t(e[i]))[C] ? o.push(r) : s.push(r);
                (r = S(t, (g = s,
                v = 0 < (m = o).length,
                y = 0 < g.length,
                n = function(t, e, i, n, o) {
                    var s, r, a, l = 0, c = "0", u = t && [], h = [], d = _, p = t || y && w.find.TAG("*", o), A = T += null == d ? 1 : Math.random() || .1, f = p.length;
                    for (o && (_ = e == E || e || o); c !== f && null != (s = p[c]); c++) {
                        if (y && s) {
                            for (r = 0,
                            e || s.ownerDocument == E || (b(s),
                            i = !x); a = g[r++]; )
                                if (a(s, e || E, i)) {
                                    n.push(s);
                                    break
                    ...
                    v && c !== l) {
                        ...
                        O.apply(n, h),
                        o && !t && 0 < h.length && 1 < l + m.length && at.uniqueSort(n)
                    }
                    return o && (T = A,
                    _ = d),
                    u
        ...
        ,
        f = at.select = function(t, e, i, n) {
            var o, s, r, a, l, c = "function" == typeof t && t, u = !n && A(t = c.selector || t);
            if (i = i || [],
            1 === u.length) {
                if (2 < (s = u[0] = u[0].slice(0)).length && "ID" === (r = s[0]).type && 9 === e.nodeType && x && w.relative[s[1].type]) {
                    if (!(e = (w.find.ID(r.matches[0].replace(nt, h), e) || [])[0]))
                        return i;
                    c && (e = e.parentNode),
                    t = t.slice(s.shift().value.length)
                }
                for (o = $.needsContext.test(t) ? 0 : s.length; o-- && (r = s[o],
                !w.relative[a = r.type]); )
                    if ((l = w.find[a]) && (n = l(r.matches[0].replace(nt, h), it.test(s[0].type) && ft(e.parentNode) || e))) {
                        if (s.splice(o, 1),
                        !(t = n.length && mt(s)))
                            return O.apply(i, n),
                            i;
            ...
            return (c || d(t, u))(n, e, !x, i, !e || it.test(t) && ft(e.parentNode) || e),
            i
        }
        ,
        p.sortStable = C.split("").sort(k).join("") === C,
    ...
    C.fn.extend({
        ...
        is: function(t) {
            return !!S(this, "string" == typeof t && T.test(t) ? C(t) : t || [], !1).length
        }
    });
    var I, k = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (C.fn.init = function(t, e, i) {
        ...
        if (!(n = "<" === t[0] && ">" === t[t.length - 1] && 3 <= t.length ? [null, t, null] : k.exec(t)) || !n[1] && e)
            return !e || e.jquery ? (e || i).find(t) : this.constructor(e).find(t);
        if (n[1]) {
            if (e = e instanceof C ? e[0] : e,
            C.merge(this, C.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : x, !0)),
            P.test(n[1]) && C.isPlainObject(e))
                for (n in e)
                    y(this[n]) ? this[n](e[n]) : this.attr(n, e[n]);
            return this
        }
        return (o = x.getElementById(n[2])) && (this[0] = o,
        this.length = 1),
        this
    }
    ).prototype = C.fn,
    ...
    C.fn.extend({
        ...
        closest: function(t, e) {
            var i, n = 0, o = this.length, s = [], r = "string" != typeof t && C(t);
            if (!T.test(t))
                for (; n < o; n++)
    ...
    C.each({
        ...
        contents: function(t) {
            return null != t.contentDocument && n(t.contentDocument) ? t.contentDocument : (D(t, "template") && (t = t.content || t),
        ...
        C.fn[n] = function(t, e) {
            ...
            1 < this.length && (z[n] || C.uniqueSort(i),
            B.test(n) && i.reverse()),
            this.pushStack(i)
        }
    });
    ...
    C.Callbacks = function(n) {
        ...
        var s, t, e, r, a = [], l = [], c = -1, u = {
            add: function() {
                return a && (t && !s && (c = a.length - 1,
                l.push(t)),
                function i(t) {
                    C.each(t, function(t, e) {
                        y(e) ? n.unique && u.has(e) || a.push(e) : e && e.length && "string" !== _(e) && i(e)
                    })
                }(arguments),
                t && !s && o()),
                this
    ...
    C.extend({
              ...
              , r = {
                ...
                then: function(e, i, n) {
                        ...
                        return function() {
                            function t() {
                                ...
                                if (!(o < l)) {
                                    ...
                                    y(e) ? a ? e.call(t, c(l, s, R, a), c(l, s, Q, a)) : (l++,
                                    e.call(t, c(l, s, R, a), c(l, s, Q, a), c(l, s, R, s.notifyWith))) : (r !== R && (i = void 0,
                                    n = [t]),
                                    (a || s.resolveWith)(i, n))
                                }
                            }
                    ...
                    return C.Deferred(function(t) {
                        s[0][3].add(c(0, t, y(n) ? n : R, t.notifyWith)),
                        s[1][3].add(c(0, t, y(e) ? e : R)),
        ...
        when: function(t) {
            ...
            var i = arguments.length
              ...
              , s = a.call(arguments)
              , r = C.Deferred();
            if (i <= 1 && (M(t, r.done(e(n)).resolve, r.reject, !i),
    ...
    C.Deferred.exceptionHook = function(t, e) {
        E.console && E.console.warn && t && L.test(t.name) && E.console.warn("jQuery.Deferred exception: " + t.message, t.stack, e)
    }
    ,
    ...
    C.extend({
        ...
        readyWait: 1,
        ready: function(t) {
            (!0 === t ? --C.readyWait : C.isReady) || (C.isReady = !0) !== t && 0 < --C.readyWait || j.resolveWith(x, [C])
        }
    }),
    C.ready.then = j.then,
    "complete" === x.readyState || "loading" !== x.readyState && !x.documentElement.doScroll ? E.setTimeout(C.ready) : (x.addEventListener("DOMContentLoaded", q),
    E.addEventListener("load", q));
    var H = function(t, e, i, n, o, s, r) {
        var a = 0
          , l = t.length
          , c = null == i;
        if ("object" === _(i))
    ...
    function U(t) {
        return t.replace(F, "ms-").replace(W, V)
    }
    function Y(t) {
        ...
        data: function(i, t) {
            ...
            if (void 0 !== i)
                return "object" == typeof i ? this.each(function() {
                    ...
                    var e;
                    return s && void 0 === t ? void 0 !== (e = $.get(s, i)) || void 0 !== (e = K(s, i)) ? e : void 0 : void this.each(function() {
                        $.set(this, i, t)
                    })
                }, null, t, 1 < arguments.length, null, !0);
            if (this.length && (o = $.get(s),
            1 === s.nodeType && !G.get(s, "hasDataAttrs"))) {
                for (e = r.length; e--; )
                    r[e] && 0 === (n = r[e].name).indexOf("data-") && (n = U(n.slice(5)),
                    K(s, n, o[n]));
    ...
    C.extend({
        queue: function(t, e, i) {
            ...
            if (t)
                return e = (e || "fx") + "queue",
                n = G.get(t, e),
                i && (!n || Array.isArray(i) ? n = G.access(t, e, C.makeArray(i)) : n.push(i)),
                n || []
        },
    ...
    C.fn.extend({
        ...
        promise: function(t, e) {
            ...
            t = void 0),
            t = t || "fx"; a--; )
                (n = G.get(r[a], t + "queueHooks")) && n.empty && (o++,
                n.empty.add(i));
            return i(),
            s.promise(e)
        }
    ...
    function at(t, e, i, n) {
        ...
        , l = a(), c = i && i[3] || (C.cssNumber[e] ? "" : "px"), u = t.nodeType && (C.cssNumber[e] || "px" !== c && +l) && et.exec(C.css(t, e));
        if (u && u[3] !== c) {
            for (l /= 2,
            c = c || u[3],
            u = +l || 1; r--; )
    ...
    function ct(t, e) {
        for (var i, n, o, s, r, a, l = [], c = 0, u = t.length; c < u; c++)
            ...
            e ? ("none" === i && (l[c] = G.get(n, "display") || null,
            l[c] || (n.style.display = "")),
            "" === n.style.display && rt(n) && (l[c] = (a = s = o = void 0,
            s = n.ownerDocument,
            r = n.nodeName,
            (a = lt[r]) || (o = s.body.appendChild(s.createElement(r)),
            a = C.css(o, "display"),
            o.parentNode.removeChild(o),
            "none" === a && (a = "block"),
            lt[r] = a)))) : "none" !== i && (l[c] = "none",
            G.set(n, "display", i)));
        for (c = 0; c < u; c++)
    ...
    var ut, ht = /^(?:checkbox|radio)$/i, dt = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i, pt = /^$|^module$|\/(?:java|ecma)script/i, At = x.createDocumentFragment().appendChild(x.createElement("div"));
    (ut = x.createElement("input")).setAttribute("type", "radio"),
    ut.setAttribute("checked", "checked"),
    ut.setAttribute("name", "t"),
    At.appendChild(ut),
    v.checkClone = At.cloneNode(!0).cloneNode(!0).lastChild.checked,
    At.innerHTML = "<textarea>x</textarea>",
    v.noCloneChecked = !!At.cloneNode(!0).lastChild.defaultValue,
    At.innerHTML = "<option></option>",
    v.option = !!At.lastChild;
    var ft = {
        thead: [1, "<table>", "</table>"],
    ...
    function gt(t, e) {
        ...
        return void 0 === e || e && D(t, e) ? C.merge([t], i) : i
    }
    function mt(t, e) {
        for (var i = 0, n = t.length; i < n; i++)
    ...
    ft.th = ft.td,
    v.option || (ft.optgroup = ft.option = [1, "<select multiple='multiple'>", "</select>"]);
    var vt = /<|&#?\w+;/;
    function yt(t, e, i, n, o) {
        for (var s, r, a, l, c, u, h = e.createDocumentFragment(), d = [], p = 0, A = t.length; p < A; p++)
            if ((s = t[p]) || 0 === s)
                if ("object" === _(s))
                    C.merge(d, s.nodeType ? [s] : s);
                else if (vt.test(s)) {
        ...
        C.event.add(t, o, {
            ...
            handler: function(t) {
                ...
                if (1 & t.isTrigger && this[o]) {
                    ...
                    e = s(this, o),
                    this[o](),
                    n !== (i = G.get(this, o)) || e ? G.set(this, o, !1) : i = {},
                    n !== i)
                        return t.stopImmediatePropagation(),
                        t.preventDefault(),
                        i.value
                } else
                    n.length && (G.set(this, o, {
                        value: C.event.trigger(C.extend(n[0], C.Event.prototype), n.slice(1), this)
                    }),
                    t.stopImmediatePropagation())
            }
        })) : void 0 === G.get(t, o) && C.event.add(t, o, Et)
    }
    C.event = {
        global: {},
        add: function(e, t, i, n, o) {
            var s, r, a, l, c, u, h, d, p, A, f, g = G.get(e);
            if (Y(e))
                ...
                c = (t = (t || "").match(O) || [""]).length; c--; )
                    ...
                    h.setup && !1 !== h.setup.call(e, n, A, r) || e.addEventListener && e.addEventListener(p, r)),
        ...
        remove: function(t, e, i, n, o) {
            var s, r, a, l, c, u, h, d, p, A, f, g = G.hasData(t) && G.get(t);
            if (g && (l = g.events)) {
                for (c = (e = (e || "").match(O) || [""]).length; c--; )
                    if (p = f = (a = bt.exec(e[c]) || [])[1],
                    A = (a[2] || "").split(".").sort(),
                    p) {
                        for (h = C.event.special[p] || {},
                        d = l[p = (n ? h.delegateType : h.bindType) || p] || [],
                        a = a[2] && new RegExp("(^|\\.)" + A.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                        r = s = d.length; s--; )
                            u = d[s],
                            !o && f !== u.origType || i && i.guid !== u.guid || a && !a.test(u.namespace) || n && n !== u.selector && ("**" !== n || !u.selector) || (d.splice(s, 1),
                            u.selector && d.delegateCount--,
                            h.remove && h.remove.call(t, u));
                        r && !d.length && (h.teardown && !1 !== h.teardown.call(t, A, g.handle) || C.removeEvent(t, p, g.handle),
                        delete l[p])
                    } else
                        for (p in l)
        ...
        dispatch: function(t) {
            var e, i, n, o, s, r, a = new Array(arguments.length), l = C.event.fix(t), c = (G.get(this, "events") || Object.create(null))[l.type] || [], u = C.event.special[l.type] || {};
            for (a[0] = l,
            ...
            !u.preDispatch || !1 !== u.preDispatch.call(this, l)) {
                ...
                e = 0; (o = r[e++]) && !l.isPropagationStopped(); )
                    ...
                    i = 0; (s = o.handlers[i++]) && !l.isImmediatePropagationStopped(); )
                        ...
                        l.data = s.data,
                        void 0 !== (n = ((C.event.special[s.origType] || {}).handle || s.handler).apply(o.elem, a)) && !1 === (l.result = n) && (l.preventDefault(),
                        l.stopPropagation()));
            ...
            if (l && c.nodeType && !("click" === t.type && 1 <= t.button))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== t.type || !0 !== c.disabled)) {
                        ...
                        r = {},
                        i = 0; i < l; i++)
                            void 0 === r[o = (n = e[i]).selector + " "] && (r[o] = n.needsContext ? -1 < C(o, this).index(c) : C.find(o, this, null, [c]).length),
                            r[o] && s.push(n);
                        s.length && a.push({
                            elem: c,
                            handlers: s
        ...
        special: {
            ...
            click: {
                setup: function(t) {
                    var e = this || t;
                    return ht.test(e.type) && e.click && D(e, "input") && Dt(e, "click", Et),
                    !1
                },
                trigger: function(t) {
                    var e = this || t;
                    return ht.test(e.type) && e.click && D(e, "input") && Dt(e, "click"),
                    !0
                },
                _default: function(t) {
                    var e = t.target;
                    return ht.test(e.type) && e.click && D(e, "input") && G.get(e, "click") || D(e, "a")
                }
            },
            beforeunload: {
    ...
    C.Event = function(t, e) {
        ...
        this.type = t.type,
        this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? Et : xt,
    ...
    function Ot(i, n, o, s) {
        n = g(n);
        var t, e, r, a, l, c, u = 0, h = i.length, d = h - 1, p = n[0], A = y(p);
        if (A || 1 < h && "string" == typeof p && !v.checkClone && St.test(p))
            return i.each(function(t) {
                var e = i.eq(t);
                A && (n[0] = p.call(this, t, e.html())),
                Ot(e, n, o, s)
            });
        if (h && (e = (t = yt(n, i[0].ownerDocument, !1, i, s)).firstChild,
        1 === t.childNodes.length && (t = e),
        e || s)) {
            for (a = (r = C.map(gt(t, "script"), Bt)).length; u < h; u++)
                l = t,
                u !== d && (l = C.clone(l, !0, !0),
                a && C.merge(r, gt(l, "script"))),
                o.call(i[u], l, u);
            if (a)
                ...
                u = 0; u < a; u++)
                    l = r[u],
                    pt.test(l.type || "") && !G.access(l, "globalEval") && C.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, {
                        nonce: l.nonce || l.getAttribute("nonce")
                    }, c) : w(l.textContent.replace(It, ""), l, c))
        }
        return i
    }
    function Rt(t, e, i) {
        for (var n, o = e ? C.filter(e, t) : t, s = 0; null != (n = o[s]); s++)
            ...
            n.parentNode && (i && ot(n) && mt(gt(n, "script")),
    ...
    C.extend({
        ...
        clone: function(t, e, i) {
            var n, o, s, r, a, l, c, u = t.cloneNode(!0), h = ot(t);
            ...
            if (e)
                if (i)
                    ...
                    Nt(t, u);
            return 0 < (r = gt(u, "script")).length && mt(r, !h && gt(t, "script")),
            u
        },
        ...
        html: function(t) {
            return H(this, function(t) {
                ...
                if (void 0 === t && 1 === e.nodeType)
                    return e.innerHTML;
                if ("string" == typeof t && !Pt.test(t) && !ft[(dt.exec(t) || ["", ""])[1].toLowerCase()]) {
                    t = C.htmlPrefilter(t);
                    try {
                        for (; i < n; i++)
    ...
    var Mt, Lt, jt, qt, Ht, Ft, Wt, Vt, Ut = new RegExp("^(" + tt + ")(?!px)[a-z%]+$","i"), Yt = function(t) {
    ...
    function Gt(t, e, i) {
        ...
        return (i = i || Yt(t)) && ("" !== (r = i.getPropertyValue(e) || i[e]) || ot(t) || (r = C.style(t, e)),
        !v.pixelBoxStyles() && Ut.test(r) && Zt.test(e) && (n = a.width,
        o = a.minWidth,
        s = a.maxWidth,
    ...
    function Xt() {
        var t;
        Vt && (Wt.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0",
        ...
        nt.appendChild(Wt).appendChild(Vt),
        t = E.getComputedStyle(Vt),
        Mt = "1%" !== t.top,
        Ft = 12 === Jt(t.marginLeft),
        Vt.style.right = "60%",
        qt = 36 === Jt(t.right),
        Lt = 36 === Jt(t.width),
        Vt.style.position = "absolute",
        jt = 12 === Jt(Vt.offsetWidth / 3),
        nt.removeChild(Wt),
        Vt = null)
    }
    function Jt(t) {
    ...
    (Vt = x.createElement("div")).style && (Vt.style.backgroundClip = "content-box",
    Vt.cloneNode(!0).style.backgroundClip = "",
    v.clearCloneStyle = "content-box" === Vt.style.backgroundClip,
    C.extend(v, {
        ...
        reliableTrDimensions: function() {
            var t, e, i, n;
            return null == Ht && (t = x.createElement("table"),
    ...
    function le(t, e, i, n, o, s) {
        ...
        if (i === (n ? "border" : "content"))
            return 0;
        for (; r < 4; r += 2)
            "margin" === i && (l += C.css(t, i + it[r], !0, o)),
            n ? ("content" === i && (l -= C.css(t, "padding" + it[r], !0, o)),
            "margin" !== i && (l -= C.css(t, "border" + it[r] + "Width", !0, o))) : (l += C.css(t, "padding" + it[r], !0, o),
            "padding" !== i ? l += C.css(t, "border" + it[r] + "Width", !0, o) : a += C.css(t, "border" + it[r] + "Width", !0, o));
    ...
    function ce(t, e, i) {
        ...
        return (!v.boxSizingReliable() && o || !v.reliableTrDimensions() && D(t, "tr") || "auto" === r || !parseFloat(r) && "inline" === C.css(t, "display", !1, n)) && t.getClientRects().length && (o = "border-box" === C.css(t, "boxSizing", !1, n),
        (s = a in t) && (r = t[a])),
        (r = parseFloat(r) || 0) + le(t, e, i || (o ? "border" : "content"), s, n, r) + "px"
    }
    ...
    C.extend({
        ...
        style: function(t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var o, s, r, a = U(e), l = oe.test(e), c = t.style;
                if (l || (e = ie(a)),
                r = C.cssHooks[e] || C.cssHooks[a],
                void 0 === i)
                    return r && "get"in r && void 0 !== (o = r.get(t, !1, n)) ? o : c[e];
                "string" == (s = typeof i) && (o = et.exec(i)) && o[1] && (i = at(t, e, o),
                s = "number"),
    ...
    C.each(["height", "width"], function(t, l) {
        C.cssHooks[l] = {
            get: function(t, e, i) {
                if (e)
                    return !ne.test(C.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? ce(t, l, i) : Qt(t, se, function() {
                        return ce(t, l, i)
                    })
            },
            set: function(t, e, i) {
                var n, o = Yt(t), s = !v.scrollboxSize() && "absolute" === o.position, r = (s || i) && "border-box" === C.css(t, "boxSizing", !1, o), a = i ? le(t, l, i, r, o) : 0;
                return r && s && (a -= Math.ceil(t["offset" + l[0].toUpperCase() + l.slice(1)] - parseFloat(o[l]) - le(t, l, "border", !1, o) - .5)),
    ...
    C.cssHooks.marginLeft = $t(v.reliableMarginLeft, function(t, e) {
        if (e)
            return (parseFloat(Gt(t, "marginLeft")) || t.getBoundingClientRect().left - Qt(t, {
                marginLeft: 0
            }, function() {
        ...
        C.cssHooks[o + s] = {
            expand: function(t) {
                for (var e = 0, i = {}, n = "string" == typeof t ? t.split(" ") : [t]; e < 4; e++)
                    i[o + it[e] + s] = n[e] || n[e - 2] || n[0];
                return i
            }
        },
        "margin" !== o && (C.cssHooks[o + s].set = ae)
    }),
    C.fn.extend({
        css: function(t, e) {
    ...
    C.fx.step = {};
    var he, de, pe, Ae, fe = /^(?:toggle|show|hide)$/, ge = /queueHooks$/;
    function me() {
        de && (!1 === x.hidden && E.requestAnimationFrame ? E.requestAnimationFrame(me) : E.setTimeout(me, C.fx.interval),
        C.fx.tick())
    }
    function ve() {
    ...
    function we(t, e, i) {
        for (var n, o = (_e.tweeners[e] || []).concat(_e.tweeners["*"]), s = 0, r = o.length; s < r; s++)
            if (n = o[s].call(i, e, t))
                return n
    }
    function _e(s, t, e) {
        var i, r, n = 0, o = _e.prefilters.length, a = C.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (r)
                return !1;
            for (var t = he || ve(), e = Math.max(0, c.startTime + c.duration - t), i = 1 - (e / c.duration || 0), n = 0, o = c.tweens.length; n < o; n++)
                c.tweens[n].run(i);
            return a.notifyWith(s, [c, i, e]),
            i < 1 && o ? e : (o || a.notifyWith(s, [c, 1, 0]),
            a.resolveWith(s, [c]),
            !1)
        }, c = a.promise({
            elem: s,
        ...
        for (function(t, e) {
            ...
            if (i = _e.prefilters[n].call(c, s, u, c.opts))
    ...
    C.Animation = C.extend(_e, {
        ...
        tweener: function(t, e) {
            ...
            ["*"]) : t.match(O)).length; n < o; n++)
                i = t[n],
                _e.tweeners[i] = _e.tweeners[i] || [],
                _e.tweeners[i].unshift(e)
        },
        prefilters: [function(t, e, i) {
            var n, o, s, r, a, l, c, u, h = "width"in e || "height"in e, d = this, p = {}, A = t.style, f = t.nodeType && rt(t), g = G.get(t, "fxshow");
            ...
            if ((l = !C.isEmptyObject(e)) || !C.isEmptyObject(p))
                for (n in h && 1 === t.nodeType && (i.overflow = [A.overflow, A.overflowX, A.overflowY],
                null == (c = g && g.display) && (c = G.get(t, "display")),
                "none" === (u = C.css(t, "display")) && (c ? u = c : (ct([t], !0),
                c = t.style.display || c,
                u = C.css(t, "display"),
                ct([t]))),
                ...
                i.overflow && (A.overflow = "hidden",
                d.always(function() {
                    A.overflow = i.overflow[0],
                    A.overflowX = i.overflow[1],
                    A.overflowY = i.overflow[2]
                })),
                l = !1,
                p)
                    l || (g ? "hidden"in g && (f = g.hidden) : g = G.access(t, "fxshow", {
                        display: c
                    }),
                    s && (g.hidden = !f),
                    f && ct([t], !0),
    ...
    C.fn.extend({
        ...
        finish: function(r) {
            return !1 !== r && (r = r || "fx"),
            this.each(function() {
                var t, e = G.get(this), i = e[r + "queue"], n = e[r + "queueHooks"], o = C.timers, s = i ? i.length : 0;
                for (e.finish = !0,
                C.queue(this, r, []),
    ...
    ,
    pe = x.createElement("input"),
    Ae = x.createElement("select").appendChild(x.createElement("option")),
    pe.type = "checkbox",
    v.checkOn = "" !== pe.value,
    v.optSelected = Ae.selected,
    (pe = x.createElement("input")).value = "t",
    pe.type = "radio",
    v.radioValue = "t" === pe.value;
    var be, Ee = C.expr.attrHandle;
    C.fn.extend({
        attr: function(t, e) {
    ...
    C.extend({
        attr: function(t, e, i) {
            ...
            if (3 !== s && 8 !== s && 2 !== s)
                return void 0 === t.getAttribute ? C.prop(t, e, i) : (1 === s && C.isXMLDoc(t) || (o = C.attrHooks[e.toLowerCase()] || (C.expr.match.bool.test(e) ? be : void 0)),
                void 0 !== i ? null === i ? void C.removeAttr(t, e) : o && "set"in o && void 0 !== (n = o.set(t, i, e)) ? n : (t.setAttribute(e, i + ""),
                i) : !(o && "get"in o && null !== (n = o.get(t, e))) && null == (n = C.find.attr(t, e)) ? void 0 : n)
        },
        attrHooks: {
            type: {
                set: function(t, e) {
    ...
    C.extend({
        prop: function(t, e, i) {
            var n, o, s = t.nodeType;
            if (3 !== s && 8 !== s && 2 !== s)
                return 1 === s && C.isXMLDoc(t) || (e = C.propFix[e] || e,
                o = C.propHooks[e]),
            ...
            if ((t = Pe(e)).length)
                for (; i = this[l++]; )
                    ...
                    n = 1 === i.nodeType && " " + Te(o) + " ") {
                        for (r = 0; s = t[r++]; )
                            n.indexOf(" " + s + " ") < 0 && (n += s + " ");
                        o !== (a = Te(n)) && i.setAttribute("class", a)
                    }
            return this
        },
        ...
        toggleClass: function(o, e) {
            ...
            return "boolean" == typeof e && r ? e ? this.addClass(o) : this.removeClass(o) : y(o) ? this.each(function(t) {
                ...
                if (r)
                    ...
                    void 0 !== o && "boolean" != s || ((t = De(this)) && G.set(this, "__className__", t),
                    this.setAttribute && this.setAttribute("class", !t && !1 !== o && G.get(this, "__className__") || ""))
            })
        },
        hasClass: function(t) {
            for (var e, i = 0, n = " " + t + " "; e = this[i++]; )
                if (1 === e.nodeType && -1 < (" " + Te(De(e)) + " ").indexOf(n))
                    return !0;
            return !1
        }
    });
    ...
    C.fn.extend({
        val: function(i) {
            ...
            })) : e ? (n = C.valHooks[e.type] || C.valHooks[e.nodeName.toLowerCase()]) && "get"in n && void 0 !== (t = n.get(e, "value")) ? t : "string" == typeof (t = e.value) ? t.replace(Se, "") : null == t ? "" : t : void 0
        }
    }),
    C.extend({
        valHooks: {
    ...
    C.extend(C.event, {
        trigger: function(t, e, i, n) {
            var o, s, r, a, l, c, u, h = [i || x], d = m.call(t, "type") ? t.type : t, p = m.call(t, "namespace") ? t.namespace.split(".") : [], A = u = s = i = i || x;
            if (3 !== i.nodeType && 8 !== i.nodeType && !ke.test(d + C.event.triggered) && (-1 < d.indexOf(".") && (d = (p = d.split(".")).shift(),
            p.sort()),
            a = d.indexOf(":") < 0 && "on" + d,
            (t = t[C.expando] ? t : new C.Event(d,"object" == typeof t && t)).isTrigger = n ? 2 : 3,
            t.namespace = p.join("."),
            ...
            n || !c.trigger || !1 !== c.trigger.apply(i, e))) {
                if (!n && !c.noBubble && !f(i)) {
                    ...
                    ke.test(r + d) || (A = A.parentNode); A; A = A.parentNode)
                        h.push(A),
                        s = A;
                ...
                for (o = 0; (A = h[o++]) && !t.isPropagationStopped(); )
                    ...
                    (l = (G.get(A, "events") || Object.create(null))[t.type] && G.get(A, "handle")) && l.apply(A, e),
                    (l = a && A[a]) && l.apply && Y(A) && (t.result = l.apply(A, e),
                    !1 === t.result && t.preventDefault());
                return t.type = d,
                n || t.isDefaultPrevented() || c._default && !1 !== c._default.apply(h.pop(), e) || !Y(i) || a && y(i[d]) && !f(i) && ((s = i[a]) && (i[a] = null),
                C.event.triggered = d,
                t.isPropagationStopped() && u.addEventListener(d, Ie),
                i[d](),
                t.isPropagationStopped() && u.removeEventListener(d, Ie),
    ...
    v.focusin || C.each({
        ...
        C.event.special[n] = {
            ...
            teardown: function() {
                var t = this.ownerDocument || this.document || this
                  , e = G.access(t, n) - 1;
                e ? G.access(t, n, e) : (t.removeEventListener(i, o, !0),
                G.remove(t, n))
            }
        }
    });
        ...
        if (Array.isArray(t) || t.jquery && !C.isPlainObject(t))
            ...
            for (n in t)
                !function i(n, t, o, s) {
                    ...
                    if (Array.isArray(t))
                        C.each(t, function(t, e) {
                            o || Oe.test(n) ? s(n, e) : i(n + "[" + ("object" == typeof e && null != e ? t : "") + "]", e, o, s)
                        });
                    else if (o || "object" !== _(t))
                        s(n, t);
                    else
                        for (e in t)
                            i(n + "[" + e + "]", t[e], o, s)
    ...
    C.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var t = this.type;
                return this.name && !C(this).is(":disabled") && Me.test(this.nodeName) && !Qe.test(t) && (this.checked || !ht.test(t))
            }).map(function(t, e) {
                var i = C(this).val();
    ...
    C.extend({
        ...
        ajax: function(t, e) {
            ...
            t = void 0),
            e = e || {};
            var u, h, d, i, p, n, A, f, o, s, g = C.ajaxSetup({}, e), m = g.context || g, v = g.context && (m.nodeType || m.jquery) ? C(m) : C.event, y = C.Deferred(), w = C.Callbacks("once memory"), _ = g.statusCode || {}, r = {}, a = {}, l = "canceled", b = {
                readyState: 0,
                ...
                setRequestHeader: function(t, e) {
                    return null == A && (t = a[t.toLowerCase()] = a[t.toLowerCase()] || t,
                    r[t] = e),
                    this
                },
                overrideMimeType: function(t) {
                    return null == A && (g.mimeType = t),
                    this
                },
            ...
            if (y.promise(b),
            g.url = ((t || g.url || Be.href) + "").replace(We, Be.protocol + "//"),
            ...
            null == g.crossDomain) {
                ...
                try {
                    n.href = g.url,
                    n.href,
                    g.crossDomain = Ze.protocol + "//" + Ze.host != n.protocol + "//" + n.host
                } catch (t) {
                    g.crossDomain = !0
                }
            }
            ...
            A)
                return b;
            for (o in (f = C.event && g.global) && 0 == C.active++ && C.event.trigger("ajaxStart"),
            g.type = g.type.toUpperCase(),
            g.hasContent = !Fe.test(g.type),
            h = g.url.replace(je, ""),
            g.hasContent ? g.data && g.processData && 0 === (g.contentType || "").indexOf("application/x-www-form-urlencoded") && (g.data = g.data.replace(Le, "+")) : (s = g.url.slice(h.length),
            g.data && (g.processData || "string" == typeof g.data) && (h += (Ne.test(h) ? "&" : "?") + g.data,
            delete g.data),
            !1 === g.cache && (h = h.replace(qe, "$1"),
            s = (Ne.test(h) ? "&" : "?") + "_=" + ze.guid++ + s),
            g.url = h + s),
            g.ifModified && (C.lastModified[h] && b.setRequestHeader("If-Modified-Since", C.lastModified[h]),
            C.etag[h] && b.setRequestHeader("If-None-Match", C.etag[h])),
            (g.data && g.hasContent && !1 !== g.contentType || e.contentType) && b.setRequestHeader("Content-Type", g.contentType),
            b.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + Ye + "; q=0.01" : "") : g.accepts["*"]),
            g.headers)
                b.setRequestHeader(o, g.headers[o]);
            if (g.beforeSend && (!1 === g.beforeSend.call(m, b, g) || A))
                return b.abort();
            if (l = "abort",
            w.add(g.complete),
            b.done(g.success),
            ...
            function c(t, e, i, n) {
                ...
                o ? (g.ifModified && ((l = b.getResponseHeader("Last-Modified")) && (C.lastModified[h] = l),
                (l = b.getResponseHeader("etag")) && (C.etag[h] = l)),
                ...
                b.status = t,
                b.statusText = (e || c) + "",
                o ? y.resolveWith(m, [s, c, b]) : y.rejectWith(m, [b, c, r]),
                b.statusCode(_),
                _ = void 0,
                f && v.trigger(o ? "ajaxSuccess" : "ajaxError", [b, g, o ? s : r]),
                w.fireWith(m, [b, c]),
                f && (v.trigger("ajaxComplete", [b, g]),
                ...
                send: function(t, e) {
                    ...
                    s = function(t) {
                        return function() {
                            ...
                            "abort" === t ? n.abort() : "error" === t ? "number" != typeof n.status ? e(0, "error") : e(n.status, n.statusText) : e(Je[n.status] || n.status, n.statusText, "text" !== (n.responseType || "text") || "string" != typeof n.responseText ? {
                                binary: n.response
                            } : {
                                text: n.responseText
    ...
    C.ajaxSetup({
        ...
        jsonpCallback: function() {
            var t = ei.pop() || C.expando + "_" + ze.guid++;
            return this[t] = !0,
            t
        }
    }),
    C.ajaxPrefilter("json jsonp", function(t, e, i) {
        var n, o, s, r = !1 !== t.jsonp && (ii.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && ii.test(t.data) && "data");
        if (r || "jsonp" === t.dataTypes[0])
            return n = t.jsonpCallback = y(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
            r ? t[r] = t[r].replace(ii, "$1" + n) : !1 !== t.jsonp && (t.url += (Ne.test(t.url) ? "&" : "?") + t.jsonp + "=" + n),
    ...
    v.createHTMLDocument = ((ti = x.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    2 === ti.childNodes.length),
    C.parseHTML = function(t, e, i) {
        return "string" != typeof t ? [] : ("boolean" == typeof e && (i = e,
        e = !1),
        e || (v.createHTMLDocument ? ((n = (e = x.implementation.createHTMLDocument("")).createElement("base")).href = x.location.href,
        e.head.appendChild(n)) : e = x),
        s = !i && [],
        (o = P.exec(t)) ? [e.createElement(o[1])] : (o = yt([t], e, s),
    ...
    C.offset = {
        setOffset: function(t, e, i) {
            var n, o, s, r, a, l, c = C.css(t, "position"), u = C(t), h = {};
            "static" === c && (t.style.position = "relative"),
            a = u.offset(),
            s = C.css(t, "top"),
            l = C.css(t, "left"),
            o = ("absolute" === c || "fixed" === c) && -1 < (s + l).indexOf("auto") ? (r = (n = u.position()).top,
            n.left) : (r = parseFloat(s) || 0,
            parseFloat(l) || 0),
    ...
    C.each({
        ...
        C.fn[e] = function(t) {
            return H(this, function(t, e, i) {
                var n;
                return f(t) ? n = t : 9 === t.nodeType && (n = t.defaultView),
                void 0 === i ? n ? n[o] : t[e] : void (n ? n.scrollTo(s ? n.pageXOffset : i, s ? i : n.pageYOffset) : t[e] = i)
            }, e, t, arguments.length)
        }
    }),
    C.each(["top", "left"], function(t, i) {
        C.cssHooks[i] = $t(v.pixelPosition, function(t, e) {
            if (e)
                return e = Gt(t, i),
                Ut.test(e) ? C(t).position()[i] + "px" : e
        })
    }),
    C.each({
        Height: "height",
        ...
        C.each({
            ...
            C.fn[s] = function(t, e) {
                ...
                return H(this, function(t, e, i) {
                    var n;
                    return f(t) ? 0 === s.indexOf("outer") ? t["inner" + r] : t.document.documentElement["client" + r] : 9 === t.nodeType ? (n = t.documentElement,
                    Math.max(t.body["scroll" + r], n["scroll" + r], t.body["offset" + r], n["offset" + r], n["client" + r])) : void 0 === i ? C.css(t, e, o) : C.style(t, e, i, o)
                }, a, i ? t : void 0, i)
            }
        })
    }),
...
function(r, h, a) {
    function c(t, e, i) {
        var n, o;
        return "getComputedStyle"in r ? (n = getComputedStyle.call(r, t, e),
        o = r.console,
        null !== n ? i && (n = n.getPropertyValue(i)) : o && o[o.error ? "error" : "log"].call(o, "getComputedStyle returning null, its possible modernizr test results are inaccurate")) : n = !e && t.currentStyle && t.currentStyle[i],
        n
    }
    function d(t) {
        return "function" != typeof h.createElement ? h.createElement(t) : m ? h.createElementNS.call(h, "http://www.w3.org/2000/svg", t) : h.createElement.apply(h, arguments)
    }
    function e(t, e) {
        return !!~("" + t).indexOf(e)
    }
    ...
    function p() {
        var t = h.body;
        return t || ((t = d(m ? "svg" : "body")).fake = !0),
        t
    }
    function A(t, e) {
        if ("object" == typeof t)
            ...
            1 == n.length ? f[n[0]] = e : (!f[n[0]] || f[n[0]]instanceof Boolean || (f[n[0]] = new Boolean(f[n[0]])),
            f[n[0]][n[1]] = e),
            s = [(e && 0 != e ? "" : "no-") + n.join("-")],
            a = g.className,
            l = f._config.classPrefix || "",
            m && (a = a.baseVal),
            f._config.enableJSClass && (r = new RegExp("(^|\\s)" + l + "no-js(\\s|$)"),
            a = a.replace(r, "$1" + l + "js$2")),
            f._config.enableClasses && (a += " " + l + s.join(" " + l),
            m ? g.className.baseVal = a : g.className = a),
            f._trigger(t, e)
        }
        var s, r, a, l;
        return f
    ...
    function i(t, e, i, n) {
        var o, s, r, a, l = "modernizr", c = d("div"), u = p();
        if (parseInt(i, 10))
            for (; i--; )
                (r = d("div")).id = n ? n[i] : l + (i + 1),
                c.appendChild(r);
        return (o = d("style")).type = "text/css",
        o.id = "s" + l,
        (u.fake ? u : c).appendChild(o),
        u.appendChild(c),
        o.styleSheet ? o.styleSheet.cssText = t : o.appendChild(h.createTextNode(t)),
        c.id = l,
        ...
        g.style.overflow = a,
        g.offsetHeight) : c.parentNode.removeChild(c),
        !!s
    }
    var n = []
      , t = {
      ...
      , f = function() {};
    f.prototype = t,
    (f = new f).addTest("ie8compat", !r.addEventListener && !!h.documentMode && 7 === h.documentMode),
    f.addTest("svg", !!h.createElementNS && !!h.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect);
    var o = r.CSS;
    f.addTest("cssescape", !!o && "function" == typeof o.escape);
    var s = "CSS"in r && "supports"in r.CSS
      , l = "supportsCSS"in r;
    f.addTest("supports", s || l),
    f.addTest("target", function() {
        var t = r.document;
    ...
    f.addTest("classlist", "classList"in g);
    var m = "svg" === g.nodeName.toLowerCase();
    ...
    f.addTest("webanimations", "animate"in d("div")),
    f.addTest("bgpositionshorthand", function() {
        var t = d("a").style
          , e = "right 10px bottom 10px";
        return t.cssText = "background-position: " + e + ";",
        t.backgroundPosition === e
    }),
    f.addTest("multiplebgs", function() {
        var t = d("a").style;
    ...
    f.addTest("rgba", function() {
        var t = d("a").style;
        return t.cssText = "background-color:rgba(150,255,150,.5)",
        -1 < ("" + t.backgroundColor).indexOf("rgba")
    }),
    f.addTest("preserve3d", function() {
        var t, e, i = r.CSS, n = !1;
        return !!(i && i.supports && i.supports("(transform-style: preserve-3d)")) || (t = d("a"),
        e = d("a"),
    ...
    f.addTest("capture", "capture"in d("input")),
    f.addTest("fileinput", function() {
    ...
    f.addTest("formattribute", function() {
        var e, t, i = d("form"), n = d("input"), o = d("div"), s = "formtest" + (new Date).getTime();
        i.id = s;
        try {
            n.setAttribute("form", s)
        } catch (t) {
            h.createAttribute && ((e = h.createAttribute("form")).nodeValue = s,
            n.setAttributeNode(e))
        }
        return o.appendChild(i),
        o.appendChild(n),
        g.appendChild(o),
        t = i.elements && 1 === i.elements.length && n.form == i,
        o.parentNode.removeChild(o),
        t
    }),
    f.addTest("placeholder", "placeholder"in d("input") && "placeholder"in d("textarea")),
    f.addTest("sandbox", "sandbox"in d("iframe")),
    f.addTest("seamless", "seamless"in d("iframe")),
    f.addTest("srcdoc", "srcdoc"in d("iframe")),
    f.addTest("imgcrossorigin", "crossOrigin"in d("img")),
    f.addTest("inputformaction", !!("formAction"in d("input")), {
        aliases: ["input-formaction"]
    }),
    f.addTest("inputformenctype", !!("formEnctype"in d("input")), {
        aliases: ["input-formenctype"]
    }),
    f.addTest("inputformmethod", !!("formMethod"in d("input"))),
    f.addTest("inputformtarget", !!("formtarget"in d("input")), {
        aliases: ["input-formtarget"]
    }),
    f.addTest("videocrossorigin", "crossOrigin"in d("video"));
    var v, y = (v = !("onblur"in h.documentElement),
    function(t, e) {
        var i;
        return !!t && (e && "string" != typeof e || (e = d(e || "div")),
        !(i = (t = "on" + t)in e) && v && (e.setAttribute || (e = d("div")),
        e.setAttribute(t, ""),
    ...
    t.hasEvent = y,
    f.addTest("ambientlight", y("devicelight", r));
    var w = d("input")
    ...
    f.input = function(t) {
        for (var e = 0, i = t.length; e < i; e++)
            b[t[e]] = !!(t[e]in w);
        return b.list && (b.list = !(!d("datalist") || !r.HTMLDataListElement)),
        b
    }(_);
    var E = "search tel url email datetime date month week time datetime-local number range color".split(" ")
      , x = {};
    f.inputtypes = function(t) {
        for (var e, i, n, o = t.length, s = 0; s < o; s++)
            w.setAttribute("type", e = t[s]),
            (n = "text" !== w.type && "style"in w) && (w.value = "1)",
            w.style.cssText = "position:absolute;visibility:hidden;",
            /^range$/.test(e) && w.style.WebkitAppearance !== a ? (g.appendChild(w),
            n = (i = h.defaultView).getComputedStyle && "textfield" !== i.getComputedStyle(w, null).WebkitAppearance && 0 !== w.offsetHeight,
            g.removeChild(w)) : /^(search|tel)$/.test(e) || (n = /^(url|email)$/.test(e) ? w.checkValidity && !1 === w.checkValidity() : "1)" != w.value)),
            x[t[s]] = !!n;
        return x
    }(E),
    ...
    f.addTest("canvasblending", function() {
        if (!1 === f.canvas)
            return !1;
        var t = d("canvas").getContext("2d");
        try {
    ...
    f.addTest("csscalc", function() {
        var t = d("a");
        return t.style.cssText = "width:" + C.join("calc(10px);width:"),
        !!t.style.length
    }),
    f.addTest("cubicbezierrange", function() {
        var t = d("a");
        return t.style.cssText = C.join("transition-timing-function:cubic-bezier(1,0,0,1.1); "),
        !!t.style.length
    }),
    f.addTest("cssgradients", function() {
        for (var t, e = "background-image:", i = "", n = 0, o = C.length - 1; n < o; n++)
            t = 0 === n ? "to " : "",
            i += e + C[n] + "linear-gradient(" + t + "left top, #9f9, white);";
        f._config.usePrefixes && (i += e + "-webkit-gradient(linear,left top,right bottom,from(#9f9),to(white));");
        var s = d("a").style;
        return s.cssText = i,
        -1 < ("" + s.backgroundImage).indexOf("gradient")
    }),
    f.addTest("opacity", function() {
        var t = d("a").style;
        return t.cssText = C.join("opacity:.55;"),
        /^0.55$/.test(t.opacity)
    }),
    f.addTest("csspositionsticky", function() {
        var t = "position:"
          , e = d("a").style;
        return e.cssText = t + C.join("sticky;" + t).slice(0, -t.length),
    ...
    f.addTest("csschunit", function() {
        var e, t = P.elem.style;
        try {
            t.fontSize = "3ch",
    ...
    f.addTest("hsla", function() {
        var t = d("a").style;
        return t.cssText = "background-color:hsla(120,40%,100%,.5)",
        e(t.backgroundColor, "rgba") || e(t.backgroundColor, "hsla")
    }),
    T = void 0 === (D = {}.hasOwnProperty) || void 0 === D.call ? function(t, e) {
    ...
    A("htmlimports", "import"in d("link")),
    f.addAsyncTest(function() {
        function i(t) {
            clearTimeout(n);
            var e = t !== a && "loadeddata" === t.type;
            o.removeEventListener("loadeddata", i, !1),
            A("audiopreload", e),
            o.parentNode.removeChild(o)
        }
        var n, o = d("audio"), t = o.style;
        if (f.audio && "preload"in o) {
            t.position = "absolute",
            t.height = 0,
            t.width = 0;
            try {
            ...
            g.appendChild(o),
            setTimeout(function() {
                o.addEventListener("loadeddata", i, !1),
                n = setTimeout(i, 300)
            }, 0)
        } else
            A("audiopreload", !1)
    ...
    f.addAsyncTest(function() {
        ...
        t.onload = function() {
            A("apng", function() {
                return void 0 !== e.getContext && (i.drawImage(t, 0, 0),
    ...
    f.addAsyncTest(function() {
        ...
        t.onload = t.onerror = function() {
            A("jpeg2000", 1 == t.width)
        }
        ,
        t.src = "data:image/jp2;base64,"
    }),
    f.addAsyncTest(function() {
        var t = new Image;
        t.onload = t.onerror = function() {
        ...
        ,
        t.src = "data:image/vnd.ms-photo;base64,SUm8AQgAAAAFAAG8AQAQAAAASgAAAIC8BAABAAAAAQAAAIG8BAABAAAAAQAAAMC8BAABAAAAWgAAAMG8BAABAAAAHwAAAAAAAAAkw91vA07+S7GFPXd2jckNV01QSE9UTwAZAYBxAAAAABP/gAAEb/8AAQAAAQAAAA=="
    }),
    f.addAsyncTest(function() {
        var t, e, i = d("img"), n = "sizes"in i;
        !n && "srcset"in i ? (t = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==",
        e = function() {
            A("sizes", 2 == i.width)
        }
        ,
        ...
        i.srcset = t + " 1w,data:image/gif;base64,R0lGODlhAgABAPAAAP///wAAACH5BAAAAAAALAAAAAACAAEAAAICBAoAOw== 8w",
        i.src = t) : A("sizes", n)
    }),
    f.addAsyncTest(function() {
        function i(t) {
        ...
        if (f.video && "autoplay"in a) {
            ...
            g.appendChild(a),
            setTimeout(function() {
                a.addEventListener("playing", i, !1),
                n = setTimeout(i, o)
            }, 0)
        } else
            A("videoautoplay", !1)
    });
    var S, I, k, B = t.testStyles = i;
    f.addTest("checked", function() {
        return B("#modernizr {position:absolute} #modernizr input {margin-left:10px;} #modernizr :checked {margin-left:20px;display:block}", function(t) {
            var e = d("input");
    ...
    B("#modernizr{display: table; direction: ltr}#modernizr div{display: table-cell; padding: 10px;}", function(t) {
        var e = t.childNodes
          , i = e[0].offsetLeft < e[1].offsetLeft;
        f.addTest("displaytable", i, {
            aliases: ["display-table"]
        })
    }, 2),
    (S = navigator.userAgent,
    I = S.match(/w(eb)?osbrowser/gi),
    k = S.match(/windows phone/gi) && S.match(/iemobile\/([0-9])+/gi) && 9 <= parseFloat(RegExp.$1),
    I || k) ? f.addTest("fontface", !1) : B('@font-face {font-family:"font";src:url("https://")}', function(t, e) {
        var i = h.getElementById("smodernizr")
          , n = i.sheet || i.styleSheet
          , o = n ? n.cssRules && n.cssRules[0] ? n.cssRules[0].cssText : n.cssText || "" : ""
          , s = /src/i.test(o) && 0 === o.indexOf(e.split(" ")[0]);
        f.addTest("fontface", s)
    }),
    B('#modernizr{font:0/0 a}#modernizr:after{content:":)";visibility:hidden;font:7px/1 a}', function(t) {
        f.addTest("generatedcontent", 6 <= t.offsetHeight)
    }),
    f.addTest("hairline", function() {
        return B("#modernizr {border:.5px solid transparent}", function(t) {
            return 1 === t.offsetHeight
        })
    }),
    f.addTest("cssinvalid", function() {
        return B("#modernizr input{height:0;border:0;padding:0;margin:0;width:10px;} #modernizr input:invalid{width:50px;}", function(t) {
            var e = d("input");
            return e.required = !0,
            t.appendChild(e),
            10 < e.clientWidth
    ...
    B("#modernizr div {width:100px;} #modernizr :last-child{width:200px;display:block}", function(t) {
        f.addTest("lastchild", t.lastChild.offsetWidth > t.firstChild.offsetWidth)
    }, 2),
    B("#modernizr div {width:1px;} #modernizr div:nth-child(2n) {width:2px;}", function(t) {
        for (var e = t.getElementsByTagName("div"), i = !0, n = 0; n < 5; n++)
            i = i && e[n].offsetWidth === n % 2 + 1;
        f.addTest("nthchild", i)
    }, 5),
    B("#modernizr{overflow: scroll; width: 40px; height: 40px; }#" + C.join("scrollbar{width:10px;} #modernizr::").split("#").slice(1).join("#") + "scrollbar{width:10px;}", function(t) {
        f.addTest("cssscrollbar", "scrollWidth"in t && 30 == t.scrollWidth)
    }),
    f.addTest("siblinggeneral", function() {
        return B("#modernizr div {width:100px;} #modernizr div ~ div {width:200px;display:block}", function(t) {
            return 200 == t.lastChild.offsetWidth
        }, 2)
    }),
    B("#modernizr{position: absolute; top: -10em; visibility:hidden; font: normal 10px arial;}#subpixel{float: left; font-size: 33.3333%;}", function(t) {
        var e = t.firstChild;
        e.innerHTML = "This is a text written in Arial",
        f.addTest("subpixelfont", !!r.getComputedStyle && "44px" !== r.getComputedStyle(e, null).getPropertyValue("width"))
    }, 1, ["subpixel"]),
    f.addTest("cssvalid", function() {
        return B("#modernizr input{height:0;border:0;padding:0;margin:0;width:10px;} #modernizr input:valid{width:50px;}", function(t) {
            var e = d("input");
            return t.appendChild(e),
            10 < e.clientWidth
        })
    }),
    B("#modernizr { height: 50vh; }", function(t) {
        var e = parseInt(r.innerHeight / 2, 10)
          , i = parseInt(c(t, null, "height"), 10);
        f.addTest("cssvhunit", i == e)
    }),
    B("#modernizr1{width: 50vmax}#modernizr2{width:50px;height:50px;overflow:scroll}#modernizr3{position:fixed;top:0;left:0;bottom:0;right:0}", function(t) {
        var e = t.childNodes[2]
          , i = t.childNodes[1]
          , n = t.childNodes[0]
          , o = parseInt((i.offsetWidth - i.clientWidth) / 2, 10)
          , s = n.clientWidth / 100
          , r = n.clientHeight / 100
          , a = parseInt(50 * Math.max(s, r), 10)
          , l = parseInt(c(e, null, "width"), 10);
        f.addTest("cssvmaxunit", u(a, l) || u(a, l - o))
    }, 3),
    B("#modernizr1{width: 50vm;width:50vmin}#modernizr2{width:50px;height:50px;overflow:scroll}#modernizr3{position:fixed;top:0;left:0;bottom:0;right:0}", function(t) {
        var e = t.childNodes[2]
          , i = t.childNodes[1]
          , n = t.childNodes[0]
          , o = parseInt((i.offsetWidth - i.clientWidth) / 2, 10)
          , s = n.clientWidth / 100
          , r = n.clientHeight / 100
          , a = parseInt(50 * Math.min(s, r), 10)
          , l = parseInt(c(e, null, "width"), 10);
        f.addTest("cssvminunit", u(a, l) || u(a, l - o))
    }, 3),
    B("#modernizr { width: 50vw; }", function(t) {
        var e = parseInt(r.innerWidth / 2, 10)
          , i = parseInt(c(t, null, "width"), 10);
        f.addTest("cssvwunit", i == e)
    }),
    f.addTest("formvalidation", function() {
        var e = d("form");
        ...
        if ("reportValidity"in e)
            return !0;
        var i, n = !1;
        return f.formvalidationapi = !0,
        e.addEventListener("submit", function(t) {
            r.opera && !r.operamini || t.preventDefault(),
            t.stopPropagation()
        }, !1),
        e.innerHTML = '<input name="modTest" required="required" /><button></button>',
        B("#modernizr form{position:absolute;top:-99999em}", function(t) {
            t.appendChild(e),
            (i = e.getElementsByTagName("input")[0]).addEventListener("invalid", function(t) {
                n = !0,
                t.preventDefault(),
                t.stopPropagation()
            }, !1),
            f.formvalidationmessage = !!i.validationMessage,
            e.getElementsByTagName("button")[0].click()
        }),
        n
    }),
    f.addTest("localizednumber", function() {
        if (!f.inputtypes.number)
            return !1;
        if (!f.formvalidation)
            return !1;
        var t, e = d("div"), i = p(), n = g.insertBefore(i, g.firstElementChild || g.firstChild);
        e.innerHTML = '<input type="number" value="1.0" step="0.1"/>';
        var o = e.childNodes[0];
        n.appendChild(e),
        o.focus();
        try {
            h.execCommand("SelectAll", !1),
            h.execCommand("InsertText", !1, "1,1")
        } catch (t) {}
        return t = "number" === o.type && 1.1 === o.valueAsNumber && o.checkValidity(),
        n.removeChild(e),
        i.fake && n.parentNode.removeChild(n),
        t
    });
    var z, N = (z = r.matchMedia || r.msMatchMedia) ? function(t) {
        var e = z(t);
    ...
    ;
    t.mq = N,
    f.addTest("mediaqueries", N("only all")),
    f.addTest("hovermq", N("(hover)")),
    f.addTest("pointermq", N("(pointer:coarse),(pointer:fine),(pointer:none)"));
    var O = "Moz O ms Webkit"
      , R = t._config.usePrefixes ? O.toLowerCase().split(" ") : [];
    t._domPrefixes = R,
    f.addTest("fileinputdirectory", function() {
        var t = d("input")
          , e = "directory";
        if (t.type = "file",
        e in t)
    ...
    var Q = t._config.usePrefixes ? O.split(" ") : [];
    t._cssomPrefixes = Q;
    t.atRule = function(t) {
        var e, i = C.length, n = r.CSSRule;
        if (void 0 === n)
            return a;
        if (!t)
            return !1;
...
function(t, e) {
    ...
    var f = {
        ...
        getTransitionDurationFromElement: function(t) {
            if (!t)
                return 0;
            var e = A(t).css("transition-duration")
              , i = A(t).css("transition-delay")
              , n = parseFloat(e)
              , o = parseFloat(i);
            return n || o ? (e = e.split(",")[0],
            i = i.split(",")[0],
            1e3 * (parseFloat(e) + parseFloat(i))) : 0
        },
        reflow: function(t) {
            return t.offsetHeight
        },
        triggerTransitionEnd: function(t) {
            A(t).trigger("transitionend")
        },
        ...
        typeCheckConfig: function(t, e, i) {
            for (var n in i)
                if (Object.prototype.hasOwnProperty.call(i, n)) {
                    var o = i[n]
                      , s = e[n]
                      , r = s && f.isElement(s) ? "element" : null === s || void 0 === s ? "" + s : {}.toString.call(s).match(/\s([a-z]+)/i)[1].toLowerCase();
        ...
        jQueryDetection: function() {
            ...
            var t = A.fn.jquery.split(" ")[0].split(".");
            if (t[0] < 2 && t[1] < 9 || 1 === t[0] && 9 === t[1] && t[2] < 1 || 4 <= t[0])
                throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")
        }
    };
    f.jQueryDetection(),
    A.fn.emulateTransitionEnd = function(t) {
        var e = this
          , i = !1;
        ...
        setTimeout(function() {
            i || f.triggerTransitionEnd(e)
        }, t),
        this
    }
    ,
    A.event.special[f.TRANSITION_END] = {
    ...
    var e, i = "alert", o = A.fn[i], a = ((e = l.prototype).close = function(t) {
        var e = this._element;
    ...
    e._getRootElement = function(t) {
        var e = f.getSelectorFromElement(t)
          , i = !1;
        return e && (i = document.querySelector(e)),
        i = i || A(t).closest(".alert")[0]
    }
    ,
    e._triggerCloseEvent = function(t) {
        var e = A.Event("close.bs.alert");
        return A(t).trigger(e),
        e
    }
    ,
    e._removeElement = function(e) {
        ...
        A(e).hasClass("fade") ? (t = f.getTransitionDurationFromElement(e),
        A(e).one(f.TRANSITION_END, function(t) {
            return i._destroyElement(e, t)
        }).emulateTransitionEnd(t)) : this._destroyElement(e)
    }
    ,
    e._destroyElement = function(t) {
        A(t).detach().trigger("closed.bs.alert").remove()
    }
    ,
    ...
    A(document).on("click.bs.alert.data-api", '[data-dismiss="alert"]', a._handleDismiss(new a)),
    A.fn[i] = a._jQueryInterface,
    A.fn[i].Constructor = a,
    A.fn[i].noConflict = function() {
        return A.fn[i] = o,
        a._jQueryInterface
    }
    ;
    var c, u = A.fn.button, d = ((c = p.prototype).toggle = function() {
        var t, e, i = !0, n = !0, o = A(this._element).closest('[data-toggle="buttons"]')[0];
        !o || (t = this._element.querySelector('input:not([type="hidden"])')) && ("radio" === t.type && (t.checked && this._element.classList.contains("active") ? i = !1 : (e = o.querySelector(".active")) && A(e).removeClass("active")),
        i && ("checkbox" !== t.type && "radio" !== t.type || (t.checked = !this._element.classList.contains("active")),
        A(t).trigger("change")),
        t.focus(),
        n = !1),
        ...
        i && A(this._element).toggleClass("active"))
    }
    ,
    c.dispose = function() {
    ...
    p._jQueryInterface = function(e) {
        return this.each(function() {
            var t = A(this).data("bs.button");
            t || (t = new p(this),
            A(this).data("bs.button", t)),
            "toggle" === e && t[e]()
        })
    }
    ,
    ...
    A(document).on("click.bs.button.data-api", '[data-toggle^="button"]', function(t) {
        var e = t.target
          , i = e;
        if (A(e).hasClass("btn") || (e = A(e).closest(".btn")[0]),
        !e || e.hasAttribute("disabled") || e.classList.contains("disabled"))
            ...
            ("LABEL" !== i.tagName || n && "checkbox" !== n.type) && d._jQueryInterface.call(A(e), "toggle")
        }
    }).on("focus.bs.button.data-api blur.bs.button.data-api", '[data-toggle^="button"]', function(t) {
        var e = A(t.target).closest(".btn")[0];
        A(e).toggleClass("focus", /^focus(in)?$/.test(t.type))
    }),
    A(window).on("load.bs.button.data-api", function() {
    ...
    A.fn.button = d._jQueryInterface,
    A.fn.button.Constructor = d,
    A.fn.button.noConflict = function() {
        return A.fn.button = u,
        d._jQueryInterface
    }
    ;
    var g, m = "carousel", v = A.fn[m], y = {
        interval: 5e3,
        keyboard: !0,
        slide: !1,
        pause: "hover",
    ...
    g.to = function(t) {
        ...
        if (!(t > this._items.length - 1 || t < 0))
            if (this._isSliding)
                A(this._element).one("slid.bs.carousel", function() {
                    return e.to(t)
                });
            else {
                if (i === t)
    ...
    g._addEventListeners = function() {
        var e = this;
        this._config.keyboard && A(this._element).on("keydown.bs.carousel", function(t) {
            return e._keydown(t)
        }),
        "hover" === this._config.pause && A(this._element).on("mouseenter.bs.carousel", function(t) {
            return e.pause(t)
    ...
    g._addTouchEventListeners = function() {
        ...
        ,
        A(this._element.querySelectorAll(".carousel-item img")).on("dragstart.bs.carousel", function(t) {
            return t.preventDefault()
        }),
        this._pointerEvent ? (A(this._element).on("pointerdown.bs.carousel", t),
        A(this._element).on("pointerup.bs.carousel", e),
        this._element.classList.add("pointer-event")) : (A(this._element).on("touchstart.bs.carousel", t),
        A(this._element).on("touchmove.bs.carousel", function(t) {
            var e;
        ...
        A(this._element).on("touchend.bs.carousel", e)))
    }
    ,
    ...
    g._triggerSlideEvent = function(t, e) {
        var i = this._getItemIndex(t)
          ...
          , o = A.Event("slide.bs.carousel", {
            relatedTarget: t,
            direction: e,
            from: n,
            to: i
        });
        return A(this._element).trigger(o),
        o
    }
    ,
    g._setActiveIndicatorElement = function(t) {
        ...
        (i = this._indicatorsElement.children[this._getItemIndex(t)]) && A(i).addClass("active"))
    }
    ,
    g._slide = function(t, e) {
        var i, n, o, s, r, a = this, l = this._element.querySelector(".active.carousel-item"), c = this._getItemIndex(l), u = e || l && this._getItemByDirection(t, l), h = this._getItemIndex(u), d = Boolean(this._interval), p = "next" === t ? (i = "carousel-item-left",
        n = "carousel-item-next",
        "left") : (i = "carousel-item-right",
        n = "carousel-item-prev",
        "right");
        u && A(u).hasClass("active") ? this._isSliding = !1 : !this._triggerSlideEvent(u, p).isDefaultPrevented() && l && u && (this._isSliding = !0,
        d && this.pause(),
        this._setActiveIndicatorElement(u),
        o = A.Event("slid.bs.carousel", {
            relatedTarget: u,
            direction: p,
            from: c,
            to: h
        }),
        A(this._element).hasClass("slide") ? (A(u).addClass(n),
        f.reflow(u),
        A(l).addClass(i),
        A(u).addClass(i),
        (s = parseInt(u.getAttribute("data-interval"), 10)) ? (this._config.defaultInterval = this._config.defaultInterval || this._config.interval,
        this._config.interval = s) : this._config.interval = this._config.defaultInterval || this._config.interval,
        r = f.getTransitionDurationFromElement(l),
        A(l).one(f.TRANSITION_END, function() {
            A(u).removeClass(i + " " + n).addClass("active"),
            A(l).removeClass("active " + n + " " + i),
            a._isSliding = !1,
            setTimeout(function() {
                return A(a._element).trigger(o)
            }, 0)
        }).emulateTransitionEnd(r)) : (A(l).removeClass("active"),
        A(u).addClass("active"),
        this._isSliding = !1,
    ...
    E._jQueryInterface = function(n) {
        return this.each(function() {
            var t = A(this).data("bs.carousel")
              , e = r({}, y, A(this).data());
            "object" == typeof n && (e = r({}, e, n));
            var i = "string" == typeof n ? n : e.slide;
            if (t || (t = new E(this,e),
            A(this).data("bs.carousel", t)),
            "number" == typeof n)
                t.to(n);
    ...
    E._dataApiClickHandler = function(t) {
        var e, i, n, o = f.getSelectorFromElement(this);
        !o || (e = A(o)[0]) && A(e).hasClass("carousel") && (i = r({}, A(e).data(), A(this).data()),
        (n = this.getAttribute("data-slide-to")) && (i.interval = !1),
        E._jQueryInterface.call(A(e), i),
        n && A(e).data("bs.carousel").to(n),
        t.preventDefault())
    }
    ,
    s(E, null, [{
    ...
    A(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", b._dataApiClickHandler),
    ...
    A.fn[m] = b._jQueryInterface,
    A.fn[m].Constructor = b,
    A.fn[m].noConflict = function() {
        return A.fn[m] = v,
        b._jQueryInterface
    }
    ;
    var x, C = "collapse", T = A.fn[C], D = {
        toggle: !0,
        parent: ""
    }, P = {
        toggle: "boolean",
        parent: "(string|element)"
    }, S = ((x = I.prototype).toggle = function() {
        A(this._element).hasClass("show") ? this.hide() : this.show()
    }
    ,
    x.show = function() {
        var t, e, i, n, o, s, r = this;
        this._isTransitioning || A(this._element).hasClass("show") || (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(t) {
            return "string" == typeof r._config.parent ? t.getAttribute("data-parent") === r._config.parent : t.classList.contains("collapse")
        })).length && (t = null),
        t && (e = A(t).not(this._selector).data("bs.collapse")) && e._isTransitioning) || (i = A.Event("show.bs.collapse"),
        A(this._element).trigger(i),
        i.isDefaultPrevented() || (t && (I._jQueryInterface.call(A(t).not(this._selector), "hide"),
        e || A(t).data("bs.collapse", null)),
        ...
        A(this._element).one(f.TRANSITION_END, function() {
            A(r._element).removeClass("collapsing").addClass("collapse show"),
            r._element.style[n] = "",
            r.setTransitioning(!1),
            A(r._element).trigger("shown.bs.collapse")
    ...
    x.hide = function() {
        ...
        if (!this._isTransitioning && A(this._element).hasClass("show")) {
            ...
            !e.isDefaultPrevented()) {
                ...
                A(this._element).addClass("collapsing").removeClass("collapse show");
                var n = this._triggerArray.length;
                if (0 < n)
                    for (var o = 0; o < n; o++) {
                        var s = this._triggerArray[o]
                          , r = f.getSelectorFromElement(s);
                        null !== r && (A([].slice.call(document.querySelectorAll(r))).hasClass("show") || A(s).addClass("collapsed").attr("aria-expanded", !1))
                    }
                this.setTransitioning(!0),
                ...
                A(this._element).one(f.TRANSITION_END, function() {
                    ...
                    A(t._element).removeClass("collapsing").addClass("collapse").trigger("hidden.bs.collapse")
    ...
    x._getConfig = function(t) {
        return (t = r({}, D, t)).toggle = Boolean(t.toggle),
        f.typeCheckConfig(C, t, P),
        t
    }
    ,
    ...
    x._getParent = function() {
        ...
        return A(n).each(function(t, e) {
            i._addAriaAndCollapsedClass(I._getTargetFromElement(e), [e])
        }),
        t
    }
    ,
    x._addAriaAndCollapsedClass = function(t, e) {
        var i = A(t).hasClass("show");
        e.length && A(e).toggleClass("collapsed", !i).attr("aria-expanded", i)
    }
    ,
    ...
    I._jQueryInterface = function(n) {
        return this.each(function() {
            var t = A(this)
              ...
              , i = r({}, D, t.data(), "object" == typeof n && n ? n : {});
            if (!e && i.toggle && "string" == typeof n && /show|hide/.test(n) && (i.toggle = !1),
            e || (e = new I(this,i),
            t.data("bs.collapse", e)),
            "string" == typeof n) {
                if (void 0 === e[n])
    ...
    A.fn[C] = S._jQueryInterface,
    A.fn[C].Constructor = S,
    A.fn[C].noConflict = function() {
        return A.fn[C] = T,
        S._jQueryInterface
    }
    ;
    var k, B = "dropdown", z = A.fn[B], N = new RegExp("38|40|27"), O = {
        offset: 0,
        flip: !0,
    ...
    }, Q = ((k = M.prototype).toggle = function() {
        var t;
        this._element.disabled || A(this._element).hasClass("disabled") || (t = A(this._menu).hasClass("show"),
        M._clearMenus(),
        t || this.show(!0))
    }
    ,
    k.show = function(t) {
        if (void 0 === t && (t = !1),
        !(this._element.disabled || A(this._element).hasClass("disabled") || A(this._menu).hasClass("show"))) {
            var e = {
                relatedTarget: this._element
            }
              , i = A.Event("show.bs.dropdown", e)
            ...
            !i.isDefaultPrevented()) {
                if (!this._inNavbar && t) {
                    ...
                    var o = this._element;
                    "parent" === this._config.reference ? o = n : f.isElement(this._config.reference) && (o = this._config.reference,
                    void 0 !== this._config.reference.jquery && (o = this._config.reference[0])),
                    "scrollParent" !== this._config.boundary && A(n).addClass("position-static"),
                    this._popper = new h(o,this._menu,this._getPopperConfig())
                }
                "ontouchstart"in document.documentElement && 0 === A(n).closest(".navbar-nav").length && A(document.body).children().on("mouseover", null, A.noop),
                this._element.focus(),
                this._element.setAttribute("aria-expanded", !0),
                A(this._menu).toggleClass("show"),
                A(n).toggleClass("show").trigger(A.Event("shown.bs.dropdown", e))
            }
        }
    }
    ,
    k.hide = function() {
        var t, e, i;
        this._element.disabled || A(this._element).hasClass("disabled") || !A(this._menu).hasClass("show") || (t = {
            relatedTarget: this._element
        },
        e = A.Event("hide.bs.dropdown", t),
        i = M._getParentFromElement(this._element),
        A(i).trigger(e),
        e.isDefaultPrevented() || (this._popper && this._popper.destroy(),
        A(this._menu).toggleClass("show"),
        A(i).toggleClass("show").trigger(A.Event("hidden.bs.dropdown", t))))
    }
    ,
    k.dispose = function() {
    ...
    k._addEventListeners = function() {
        var e = this;
        A(this._element).on("click.bs.dropdown", function(t) {
            t.preventDefault(),
            t.stopPropagation(),
            e.toggle()
        })
    ...
    k._getConfig = function(t) {
        return t = r({}, this.constructor.Default, A(this._element).data(), t),
        f.typeCheckConfig(B, t, this.constructor.DefaultType),
        t
    }
    ,
    k._getMenuElement = function() {
        var t;
        return this._menu || (t = M._getParentFromElement(this._element)) && (this._menu = t.querySelector(".dropdown-menu")),
        this._menu
    }
    ,
    k._getPlacement = function() {
        var t = A(this._element.parentNode)
          , e = "bottom-start";
        return t.hasClass("dropup") ? e = A(this._menu).hasClass("dropdown-menu-right") ? "top-end" : "top-start" : t.hasClass("dropright") ? e = "right-start" : t.hasClass("dropleft") ? e = "left-start" : A(this._menu).hasClass("dropdown-menu-right") && (e = "bottom-end"),
        e
    }
    ,
    ...
    M._jQueryInterface = function(e) {
        return this.each(function() {
            var t = A(this).data("bs.dropdown");
            if (t || (t = new M(this,"object" == typeof e ? e : null),
            A(this).data("bs.dropdown", t)),
            "string" == typeof e) {
                if (void 0 === t[e])
    ...
    M._clearMenus = function(t) {
        if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
            for (var e = [].slice.call(document.querySelectorAll('[data-toggle="dropdown"]')), i = 0, n = e.length; i < n; i++) {
                var o, s, r = M._getParentFromElement(e[i]), a = A(e[i]).data("bs.dropdown"), l = {
                    relatedTarget: e[i]
                };
                t && "click" === t.type && (l.clickEvent = t),
                a && (o = a._menu,
                !A(r).hasClass("show") || t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && A.contains(r, t.target) || (s = A.Event("hide.bs.dropdown", l),
                A(r).trigger(s),
                s.isDefaultPrevented() || ("ontouchstart"in document.documentElement && A(document.body).children().off("mouseover", null, A.noop),
                e[i].setAttribute("aria-expanded", "false"),
                a._popper && a._popper.destroy(),
                A(o).removeClass("show"),
                A(r).removeClass("show").trigger(A.Event("hidden.bs.dropdown", l)))))
            }
    }
    ,
    M._getParentFromElement = function(t) {
        var e, i = f.getSelectorFromElement(t);
        return i && (e = document.querySelector(i)),
        e || t.parentNode
    }
    ,
    M._dataApiKeydownHandler = function(t) {
        if (!(/input|textarea/i.test(t.target.tagName) ? 32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || A(t.target).closest(".dropdown-menu").length) : !N.test(t.which)) && !this.disabled && !A(this).hasClass("disabled")) {
            var e = M._getParentFromElement(this)
              , i = A(e).hasClass("show");
            if (i || 27 !== t.which) {
                if (t.preventDefault(),
                t.stopPropagation(),
                !i || i && (27 === t.which || 32 === t.which))
                    return 27 === t.which && A(e.querySelector('[data-toggle="dropdown"]')).trigger("focus"),
                ...
                var n, o = [].slice.call(e.querySelectorAll(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)")).filter(function(t) {
                    return A(t).is(":visible")
                });
                0 !== o.length && (n = o.indexOf(t.target),
                38 === t.which && 0 < n && n--,
    ...
    A(document).on("keydown.bs.dropdown.data-api", '[data-toggle="dropdown"]', Q._dataApiKeydownHandler).on("keydown.bs.dropdown.data-api", ".dropdown-menu", Q._dataApiKeydownHandler).on("click.bs.dropdown.data-api keyup.bs.dropdown.data-api", Q._clearMenus).on("click.bs.dropdown.data-api", '[data-toggle="dropdown"]', function(t) {
        t.preventDefault(),
        t.stopPropagation(),
    ...
    var L, j = A.fn.modal, q = {
        ...
        focus: "boolean",
        show: "boolean"
    }, F = ((L = W.prototype).toggle = function(t) {
        return this._isShown ? this.hide() : this.show(t)
    }
    ,
    L.show = function(t) {
        var e, i = this;
        this._isShown || this._isTransitioning || (A(this._element).hasClass("fade") && (this._isTransitioning = !0),
        ...
        A(this._element).on("click.dismiss.bs.modal", '[data-dismiss="modal"]', function(t) {
            return i.hide(t)
        }),
        A(this._dialog).on("mousedown.dismiss.bs.modal", function() {
            A(i._element).one("mouseup.dismiss.bs.modal", function(t) {
                A(t.target).is(i._element) && (i._ignoreBackdropClick = !0)
            })
        }),
    ...
    L.hide = function(t) {
        var e, i, n, o = this;
        t && t.preventDefault(),
        this._isShown && !this._isTransitioning && (e = A.Event("hide.bs.modal"),
        A(this._element).trigger(e),
        this._isShown && !e.isDefaultPrevented() && (this._isShown = !1,
        (i = A(this._element).hasClass("fade")) && (this._isTransitioning = !0),
        this._setEscapeEvent(),
        this._setResizeEvent(),
        ...
        i ? (n = f.getTransitionDurationFromElement(this._element),
        A(this._element).one(f.TRANSITION_END, function(t) {
    ...
    L._triggerBackdropTransition = function() {
        ...
        if ("static" === this._config.backdrop) {
            var e = A.Event("hidePrevented.bs.modal");
            if (A(this._element).trigger(e),
            e.defaultPrevented)
                return;
            ...
            A(this._element).off(f.TRANSITION_END),
            A(this._element).one(f.TRANSITION_END, function() {
                t._element.classList.remove("modal-static"),
                i || A(t._element).one(f.TRANSITION_END, function() {
    ...
    ,
    L._showElement = function(t) {
        var e = this
          , i = A(this._element).hasClass("fade")
          , n = this._dialog ? this._dialog.querySelector(".modal-body") : null;
        function o() {
            e._config.focus && e._element.focus(),
            e._isTransitioning = !1,
            A(e._element).trigger(r)
        }
        ...
        var s, r = A.Event("shown.bs.modal", {
            relatedTarget: t
        });
        i ? (s = f.getTransitionDurationFromElement(this._dialog),
        A(this._dialog).one(f.TRANSITION_END, o).emulateTransitionEnd(s)) : o()
    }
    ,
    ...
    L._setEscapeEvent = function() {
        var e = this;
        this._isShown ? A(this._element).on("keydown.dismiss.bs.modal", function(t) {
    ...
    L._setResizeEvent = function() {
        var e = this;
        this._isShown ? A(window).on("resize.bs.modal", function(t) {
    ...
    L._hideModal = function() {
        ...
        this._showBackdrop(function() {
            ...
            t._resetAdjustments(),
            t._resetScrollbar(),
            A(t._element).trigger("hidden.bs.modal")
        })
    }
    ,
    ...
    ,
    L._showBackdrop = function(t) {
        var e, i, n = this, o = A(this._element).hasClass("fade") ? "fade" : "";
        if (this._isShown && this._config.backdrop) {
            if (this._backdrop = document.createElement("div"),
            this._backdrop.className = "modal-backdrop",
            o && this._backdrop.classList.add(o),
            A(this._backdrop).appendTo(document.body),
            A(this._element).on("click.dismiss.bs.modal", function(t) {
                n._ignoreBackdropClick ? n._ignoreBackdropClick = !1 : t.target === t.currentTarget && n._triggerBackdropTransition()
            }),
            o && f.reflow(this._backdrop),
            A(this._backdrop).addClass("show"),
            !t)
                return;
            if (!o)
                return void t();
            var s = f.getTransitionDurationFromElement(this._backdrop);
            A(this._backdrop).one(f.TRANSITION_END, t).emulateTransitionEnd(s)
        } else
            !this._isShown && this._backdrop ? (A(this._backdrop).removeClass("show"),
            e = function() {
                n._removeBackdrop(),
                t && t()
            }
            ,
            A(this._element).hasClass("fade") ? (i = f.getTransitionDurationFromElement(this._backdrop),
            A(this._backdrop).one(f.TRANSITION_END, e).emulateTransitionEnd(i)) : e()) : t && t()
    }
    ,
    ...
    L._setScrollbar = function() {
        var t, e, i, n, o = this;
        this._isBodyOverflowing && (t = [].slice.call(document.querySelectorAll(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top")),
        e = [].slice.call(document.querySelectorAll(".sticky-top")),
        A(t).each(function(t, e) {
            var i = e.style.paddingRight
              , n = A(e).css("padding-right");
            A(e).data("padding-right", i).css("padding-right", parseFloat(n) + o._scrollbarWidth + "px")
        }),
        A(e).each(function(t, e) {
            var i = e.style.marginRight
              , n = A(e).css("margin-right");
            A(e).data("margin-right", i).css("margin-right", parseFloat(n) - o._scrollbarWidth + "px")
        }),
        i = document.body.style.paddingRight,
        n = A(document.body).css("padding-right"),
        A(document.body).data("padding-right", i).css("padding-right", parseFloat(n) + this._scrollbarWidth + "px")),
    ...
    L._resetScrollbar = function() {
        ...
        A(e).each(function(t, e) {
            var i = A(e).data("margin-right");
            void 0 !== i && A(e).css("margin-right", i).removeData("margin-right")
        });
    ...
    ,
    W._jQueryInterface = function(i, n) {
        return this.each(function() {
            var t = A(this).data("bs.modal")
              , e = r({}, q, A(this).data(), "object" == typeof i && i ? i : {});
            if (t || (t = new W(this,e),
            A(this).data("bs.modal", t)),
            "string" == typeof i) {
                if (void 0 === t[i])
                    throw new TypeError('No method named "' + i + '"');
                t[i](n)
    ...
    A(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function(t) {
        var e, i = this, n = f.getSelectorFromElement(this);
        n && (e = document.querySelector(n));
        var o = A(e).data("bs.modal") ? "toggle" : r({}, A(e).data(), A(this).data());
        "A" !== this.tagName && "AREA" !== this.tagName || t.preventDefault();
        var s = A(e).one("show.bs.modal", function(t) {
            t.isDefaultPrevented() || s.one("hidden.bs.modal", function() {
                A(i).is(":visible") && i.focus()
            })
        });
        F._jQueryInterface.call(A(e), o, this)
    }),
    A.fn.modal = F._jQueryInterface,
    A.fn.modal.Constructor = F,
    ...
    function Z(t, s, e) {
        ...
        if (e && "function" == typeof e)
            return e(t);
        for (var i = (new window.DOMParser).parseFromString(t, "text/html"), r = Object.keys(s), a = [].slice.call(i.body.querySelectorAll("*")), n = 0, o = a.length; n < o; n++)
            !function(t) {
                var e = a[t]
                  , i = e.nodeName.toLowerCase();
                if (-1 === r.indexOf(e.nodeName.toLowerCase()))
                ...
                n.forEach(function(t) {
                    !function(t, e) {
                        ...
                        if (-1 !== e.indexOf(i))
                            return -1 === V.indexOf(i) || Boolean(t.nodeValue.match(U) || t.nodeValue.match(Y));
    ...
    var G, $ = "tooltip", X = A.fn[$], J = new RegExp("(^|\\s)bs-tooltip\\S+","g"), K = ["sanitize", "whiteList", "sanitizeFn"], tt = {
        animation: "boolean",
        template: "string",
    ...
    }, ot = ((G = st.prototype).enable = function() {
        this._isEnabled = !0
    }
    ,
    G.disable = function() {
        ...
        if (this._isEnabled)
            if (t) {
                var e = this.constructor.DATA_KEY
                  , i = A(t.currentTarget).data(e);
                i || (i = new this.constructor(t.currentTarget,this._getDelegateConfig()),
                A(t.currentTarget).data(e, i)),
                i._activeTrigger.click = !i._activeTrigger.click,
                i._isWithActiveTrigger() ? i._enter(null, i) : i._leave(null, i)
            } else {
                if (A(this.getTipElement()).hasClass("show"))
    ...
    G.show = function() {
        ...
        var t = A.Event(this.constructor.Event.SHOW);
        if (this.isWithContent() && this._isEnabled) {
            A(this.element).trigger(t);
            var i = f.findShadowRoot(this.element)
              , n = A.contains(null !== i ? i : this.element.ownerDocument.documentElement, this.element);
            ...
            this.setContent(),
            this.config.animation && A(o).addClass("fade");
            ...
            A(o).data(this.constructor.DATA_KEY, this),
            A.contains(this.element.ownerDocument.documentElement, this.tip) || A(o).appendTo(l),
            ...
            var c, u = function() {
                ...
                var t = e._hoverState;
                e._hoverState = null,
                A(e.element).trigger(e.constructor.Event.SHOWN),
                "out" === t && e._leave(null, e)
            };
            A(this.tip).hasClass("fade") ? (c = f.getTransitionDurationFromElement(this.tip),
            A(this.tip).one(f.TRANSITION_END, u).emulateTransitionEnd(c)) : u()
        }
    }
    ,
    G.hide = function(t) {
        function e() {
            ...
            A(n.element).trigger(n.constructor.Event.HIDDEN),
            null !== n._popper && n._popper.destroy(),
            t && t()
        }
        var i, n = this, o = this.getTipElement(), s = A.Event(this.constructor.Event.HIDE);
        A(this.element).trigger(s),
        s.isDefaultPrevented() || (A(o).removeClass("show"),
        "ontouchstart"in document.documentElement && A(document.body).children().off("mouseover", null, A.noop),
        this._activeTrigger.click = !1,
        this._activeTrigger.focus = !1,
        this._activeTrigger.hover = !1,
        A(this.tip).hasClass("fade") ? (i = f.getTransitionDurationFromElement(o),
        A(o).one(f.TRANSITION_END, e).emulateTransitionEnd(i)) : e(),
        this._hoverState = "")
    }
    ,
    G.update = function() {
    ...
    G.addAttachmentClass = function(t) {
        A(this.getTipElement()).addClass("bs-tooltip-" + t)
    }
    ,
    ...
    G.setContent = function() {
        ...
        this.setElementContent(A(t.querySelectorAll(".tooltip-inner")), this.getTitle()),
        A(t).removeClass("fade show")
    }
    ,
    G.setElementContent = function(t, e) {
        "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = Z(e, this.config.whiteList, this.config.sanitizeFn)),
        t.html(e)) : t.text(e) : this.config.html ? A(e).parent().is(t) || t.empty().append(e) : t.text(A(e).text())
    }
    ,
    G.getTitle = function() {
    ...
    G._getContainer = function() {
        return !1 === this.config.container ? document.body : f.isElement(this.config.container) ? A(this.config.container) : A(document).find(this.config.container)
    }
    ,
    ...
    G._setListeners = function() {
        ...
        this.config.trigger.split(" ").forEach(function(t) {
            var e, i;
            "click" === t ? A(n.element).on(n.constructor.Event.CLICK, n.config.selector, function(t) {
                return n.toggle(t)
            }) : "manual" !== t && (e = "hover" === t ? n.constructor.Event.MOUSEENTER : n.constructor.Event.FOCUSIN,
            i = "hover" === t ? n.constructor.Event.MOUSELEAVE : n.constructor.Event.FOCUSOUT,
            A(n.element).on(e, n.config.selector, function(t) {
                return n._enter(t)
    ...
    G._enter = function(t, e) {
        ...
        (e = e || A(t.currentTarget).data(i)) || (e = new this.constructor(t.currentTarget,this._getDelegateConfig()),
        A(t.currentTarget).data(i, e)),
        t && (e._activeTrigger["focusin" === t.type ? "focus" : "hover"] = !0),
        A(e.getTipElement()).hasClass("show") || "show" === e._hoverState ? e._hoverState = "show" : (clearTimeout(e._timeout),
        e._hoverState = "show",
    ...
    G._getConfig = function(t) {
        ...
        f.typeCheckConfig($, t, this.constructor.DefaultType),
        t.sanitize && (t.template = Z(t.template, t.whiteList, t.sanitizeFn)),
        t
    }
    ,
    ...
    G._fixTransition = function() {
        ...
        null === t.getAttribute("x-placement") && (A(t).removeClass("fade"),
    ...
    ,
    st._jQueryInterface = function(i) {
        return this.each(function() {
            var t = A(this).data("bs.tooltip")
              , e = "object" == typeof i && i;
            if ((t || !/dispose|hide/.test(i)) && (t || (t = new st(this,e),
            A(this).data("bs.tooltip", t)),
            "string" == typeof i)) {
                if (void 0 === t[i])
                    throw new TypeError('No method named "' + i + '"');
                t[i]()
      ...
      , dt = function(t) {
        ...
        n._jQueryInterface = function(i) {
            return this.each(function() {
                ...
                if ((t || !/dispose|hide/.test(i)) && (t || (t = new n(this,e),
                A(this).data("bs.popover", t)),
                "string" == typeof i)) {
                    if (void 0 === t[i])
                        throw new TypeError('No method named "' + i + '"');
                    t[i]()
    ...
    A.fn[rt] = dt._jQueryInterface,
    A.fn[rt].Constructor = dt,
    A.fn[rt].noConflict = function() {
        return A.fn[rt] = at,
        dt._jQueryInterface
    }
    ;
    var pt, At = "scrollspy", ft = A.fn[At], gt = {
        offset: 10,
        method: "auto",
        target: ""
    }, mt = {
    ...
    }, vt = ((pt = yt.prototype).refresh = function() {
        var e = this
        ...
        [].slice.call(document.querySelectorAll(this._selector)).map(function(t) {
            var e, i = f.getSelectorFromElement(t);
            if (i && (e = document.querySelector(i)),
            e) {
                var n = e.getBoundingClientRect();
                if (n.width || n.height)
                    return [A(e)[o]().top + s, i]
            }
            return null
        }).filter(function(t) {
            return t
    ...
    pt._getConfig = function(t) {
        var e;
        return "string" != typeof (t = r({}, gt, "object" == typeof t && t ? t : {})).target && f.isElement(t.target) && ((e = A(t.target).attr("id")) || (e = f.getUID(At),
        A(t.target).attr("id", e)),
        t.target = "#" + e),
        f.typeCheckConfig(At, t, mt),
        t
    }
    ,
    ...
    pt._activate = function(e) {
        ...
        var t = this._selector.split(",").map(function(t) {
          ...
          , i = A([].slice.call(document.querySelectorAll(t.join(","))));
    ...
    yt._jQueryInterface = function(e) {
        return this.each(function() {
            var t = A(this).data("bs.scrollspy");
            if (t || (t = new yt(this,"object" == typeof e && e),
            A(this).data("bs.scrollspy", t)),
            "string" == typeof e) {
                if (void 0 === t[e])
                    throw new TypeError('No method named "' + e + '"');
                t[e]()
    ...
    function yt(t, e) {
        ...
        A(this._scrollElement).on("scroll.bs.scrollspy", function(t) {
            return i._process(t)
        }),
        this.refresh(),
        this._process()
    ...
    A.fn[At] = vt._jQueryInterface,
    A.fn[At].Constructor = vt,
    A.fn[At].noConflict = function() {
        return A.fn[At] = ft,
        vt._jQueryInterface
    }
    ;
    var wt, _t = A.fn.tab, bt = ((wt = Et.prototype).show = function() {
        var t, e, i, n, o, s, r, a, l = this;
        this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && A(this._element).hasClass("active") || A(this._element).hasClass("disabled") || (e = A(this._element).closest(".nav, .list-group")[0],
        i = f.getSelectorFromElement(this._element),
        e && (n = "UL" === e.nodeName || "OL" === e.nodeName ? "> li > .active" : ".active",
        o = (o = A.makeArray(A(e).find(n)))[o.length - 1]),
        ...
        r.isDefaultPrevented() || s.isDefaultPrevented() || (i && (t = document.querySelector(i)),
        this._activate(this._element, e),
        a = function() {
            var t = A.Event("hidden.bs.tab", {
                relatedTarget: l._element
            })
              , e = A.Event("shown.bs.tab", {
                relatedTarget: o
            });
            A(o).trigger(t),
            A(l._element).trigger(e)
        }
        ,
    ...
    wt._activate = function(t, e, i) {
        ...
        var o, s = this, r = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? A(e).children(".active") : A(e).find("> li > .active"))[0], a = i && r && A(r).hasClass("fade");
        r && a ? (o = f.getTransitionDurationFromElement(r),
        A(r).removeClass("show").one(f.TRANSITION_END, n).emulateTransitionEnd(o)) : n()
    }
    ,
    wt._transitionComplete = function(t, e, i) {
        var n, o, s;
        e && (A(e).removeClass("active"),
        (n = A(e.parentNode).find("> .dropdown-menu .active")[0]) && A(n).removeClass("active"),
        "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1)),
        A(t).addClass("active"),
        "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0),
        f.reflow(t),
        t.classList.contains("fade") && t.classList.add("show"),
        t.parentNode && A(t.parentNode).hasClass("dropdown-menu") && ((o = A(t).closest(".dropdown")[0]) && (s = [].slice.call(o.querySelectorAll(".dropdown-toggle")),
        A(s).addClass("active")),
    ...
    A(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(t) {
        t.preventDefault(),
        bt._jQueryInterface.call(A(this), "show")
    }),
    A.fn.tab = bt._jQueryInterface,
    A.fn.tab.Constructor = bt,
    A.fn.tab.noConflict = function() {
        return A.fn.tab = _t,
        bt._jQueryInterface
    }
    ;
    var xt, Ct = A.fn.toast, Tt = {
        animation: "boolean",
        autohide: "boolean",
        delay: "number"
    }, Dt = {
        ...
        autohide: !0,
        delay: 500
    }, Pt = ((xt = St.prototype).show = function() {
        var t, e, i = this, n = A.Event("show.bs.toast");
        ...
        t = function() {
            ...
            A(i._element).trigger("shown.bs.toast"),
            i._config.autohide && (i._timeout = setTimeout(function() {
                i.hide()
            }, i._config.delay))
        }
        ,
        ...
        this._config.animation ? (e = f.getTransitionDurationFromElement(this._element),
        A(this._element).one(f.TRANSITION_END, t).emulateTransitionEnd(e)) : t())
    }
    ,
    xt.hide = function() {
        var t;
        this._element.classList.contains("show") && (t = A.Event("hide.bs.toast"),
        A(this._element).trigger(t),
    ...
    xt.dispose = function() {
        ...
        A(this._element).off("click.dismiss.bs.toast"),
        A.removeData(this._element, "bs.toast"),
        this._element = null,
        this._config = null
    }
    ,
    xt._getConfig = function(t) {
        return t = r({}, Dt, A(this._element).data(), "object" == typeof t && t ? t : {}),
        f.typeCheckConfig("toast", t, this.constructor.DefaultType),
        t
    }
    ,
    xt._setListeners = function() {
        var t = this;
        A(this._element).on("click.dismiss.bs.toast", '[data-dismiss="toast"]', function() {
            return t.hide()
        })
    }
    ,
    xt._close = function() {
        function t() {
            ...
            A(i._element).trigger("hidden.bs.toast")
        }
        var e, i = this;
    ...
    St._jQueryInterface = function(i) {
        return this.each(function() {
            var t = A(this)
              , e = t.data("bs.toast");
            if (e || (e = new St(this,"object" == typeof i && i),
            t.data("bs.toast", e)),
            "string" == typeof i) {
                if (void 0 === e[i])
                    throw new TypeError('No method named "' + i + '"');
    ...
    A.fn.toast = Pt._jQueryInterface,
    A.fn.toast.Constructor = Pt,
    A.fn.toast.noConflict = function() {
        return A.fn.toast = Ct,
        Pt._jQueryInterface
    }
    ,
    t.Alert = a,
...
function(n) {
    ...
    n.fn.menumaker = function(t) {
        ...
        return this.each(function() {
            n(this).find(".navbar-toggler").on("click", function() {
                ...
                t.hasClass("open") ? t.slideToggle().removeClass("open") : (t.slideToggle().addClass("open"),
                "dropdown" === i.format && t.find("ul").show())
            }),
            e.find(".navbar-nav li ul").parent().addClass("has-sub"),
            e.find(".navbar-nav li ul li").parent().addClass("sub-menu");
            "multitoggle" === i.format ? (e.find(".has-sub").prepend('<span class="submenu-button"></span>'),
            e.find(".navbar-nav > li.has-sub > .submenu-button").on("click", function() {
                ...
                n(this).parents(".navbar-nav > li.has-sub").toggleClass("active").siblings(".has-sub").children(".sub-menu").slideUp().removeClass("open").parents("li").removeClass("active")
            }),
            e.find(".sub-menu > li.has-sub > .submenu-button").on("click", function() {
                n(this).next(".sub-menu").slideToggle(),
                n(this).siblings("ul").addClass("open").slideToggle(),
                n(this).parents(".sub-menu > li").toggleClass("active").siblings(".has-sub").children(".sub-menu").slideUp().removeClass("open").parents("li").removeClass("active"),
    ...
    n(document).ready(function() {
        ...
        n(".navbar-nav li").find('a[href="' + e + '"]').closest("li").addClass("active").parents().eq(1).addClass("current"),
        n(".navbar-nav li.has-sub ul li").find('a[href="' + e + '"]').parents().eq(4).addClass("current")
    }),
    n(".navbar-default .attr-nav").each(function() {
        n("li.search > a", this).on("click", function(t) {
            t.preventDefault(),
            n(".top-search").slideToggle()
        })
    }),
...
function(A) {
    A.fn.extend({
        easyResponsiveTabs: function(l) {
            ...
            A(this).on("bind", "tabactivate", function(t, e) {
                "function" == typeof l.activate && l.activate.call(e, t)
            }),
            this.each(function() {
                var i, s = A(this), t = s.find("ul.resp-tabs-list." + l.tabidentify), r = s.attr("id");
                s.find("ul.resp-tabs-list." + l.tabidentify + " li").addClass("resp-tab-item").addClass(l.tabidentify),
                s.css({
                    display: "block",
                    width: h
                }),
                "vertical" == l.type && s.find(".resp-tabs-container." + l.tabidentify).css("border-color", l.active_content_border_color),
                s.find(".resp-tabs-container." + l.tabidentify + " > div").addClass("resp-tab-content").addClass(l.tabidentify),
                function() {
                    "vertical" == c && s.addClass("resp-vtabs").addClass(l.tabidentify);
                    1 == u && s.css({
                        width: "100%",
                        margin: "0px"
                    });
                    "accordion" == c && (s.addClass("resp-easy-accordion").addClass(l.tabidentify),
                    s.find(".resp-tabs-list").css("display", "none"))
                }(),
                s.find(".resp-tab-content." + l.tabidentify).before("<h2 class='resp-accordion " + l.tabidentify + "' role='tab'><span class='resp-arrow'></span></h2>"),
                s.find(".resp-tab-content." + l.tabidentify).prev("h2").css({
                ...
                s.find(".resp-accordion").each(function() {
                    i = A(this);
                    var t = s.find(".resp-tab-item:eq(" + n + ")")
                      , e = s.find(".resp-accordion:eq(" + n + ")");
                    e.append(t.html()),
                    e.data(t.data()),
                    i.attr("aria-controls", l.tabidentify + "_tab_item-" + n),
                    n++
                });
                var e = 0;
                s.find(".resp-tab-item").each(function() {
                    ...
                    s.find(".resp-tab-content." + l.tabidentify).each(function() {
                        A(this).attr("aria-labelledby", l.tabidentify + "_tab_item-" + t).css({
                            "border-color": l.active_border_color
                        }),
                        t++
                    }),
                ...
                var o, a = 0;
                "" == d || null !== (o = d.match(new RegExp(r + "([0-9]+)"))) && 2 === o.length && (a = parseInt(o[1], 10) - 1,
                e < a && (a = 0)),
                A(s.find(".resp-tab-item." + l.tabidentify)[a]).addClass("resp-tab-active").css({
                    "background-color": l.activetab_bg,
                    "border-color": l.active_border_color
                }),
                !0 === l.closed || "accordion" === l.closed && !t.is(":visible") || "tabs" === l.closed && t.is(":visible") || (A(s.find(".resp-accordion." + l.tabidentify)[a]).addClass("resp-tab-active").css({
                    "background-color": l.activetab_bg + " !important",
                    "border-color": l.active_border_color,
                    background: "none"
                }),
                A(s.find(".resp-tab-content." + l.tabidentify)[a]).addClass("resp-tab-content-active").addClass(l.tabidentify).attr("style", "display:block")),
                s.find("[role=tab]").each(function() {
                    A(this).on("click", function() {
                        var t, e, i, n = A(this), o = n.attr("aria-controls");
                        if (n.hasClass("resp-accordion") && n.hasClass("resp-tab-active"))
                            return s.find(".resp-tab-content-active." + l.tabidentify).slideUp("", function() {
                                A(this).addClass("resp-accordion-closed")
                            }),
                            n.removeClass("resp-tab-active").css({}),
                            !1;
                        !n.hasClass("resp-tab-active") && n.hasClass("resp-accordion") ? (s.find(".resp-tab-active." + l.tabidentify).removeClass("resp-tab-active").css({}),
                        s.find(".resp-tab-content-active." + l.tabidentify).slideUp().removeClass("resp-tab-content-active resp-accordion-closed"),
                        s.find("[aria-controls=" + o + "]").addClass("resp-tab-active").css({}),
                        s.find(".resp-tab-content[aria-labelledby = " + o + "]." + l.tabidentify).slideDown().addClass("resp-tab-content-active")) : (s.find(".resp-tab-active." + l.tabidentify).removeClass("resp-tab-active").css({}),
                        s.find(".resp-tab-content-active." + l.tabidentify).removeAttr("style").removeClass("resp-tab-content-active").removeClass("resp-accordion-closed"),
                        s.find("[aria-controls=" + o + "]").addClass("resp-tab-active").css({}),
                        s.find(".resp-tab-content[aria-labelledby = " + o + "]." + l.tabidentify).addClass("resp-tab-content-active").attr("style", "display:block")),
                        n.trigger("tabactivate", n),
                        p && (t = window.location.hash,
                        o.split("tab_item-"),
                        i = (i = "") != t ? (e = new RegExp(r + "[0-9]+"),
                        null != t.match(e) ? t.replace(e, i) : t + "|" + i) : "" + i,
...
function(l, i, o, a) {
    ...
    c.prototype.to = function(t, e) {
        ...
        (n = (((t = i + o) - a) % r + r) % r + a) !== t && n - o <= l && 0 < n - o && (i = n - o,
        t = n,
...
function(a, s) {
    ...
    e.prototype.load = function(t) {
        ...
        !i || -1 < a.inArray(e.get(0), this._loaded) || (i.each(a.proxy(function(t, e) {
            var i, n = a(e), o = 1 < s.devicePixelRatio && n.attr("data-src-retina") || n.attr("data-src") || n.attr("data-srcset");
...
function(u, e) {
    ...
    i.prototype.play = function(t) {
        var e, i = u(t.target).closest("." + this._core.settings.itemClass), n = this._videos[i.attr("data-video")], o = n.width || "100%", s = n.height || this._core.$stage.height();
        this._playing || (this._core.enter("playing"),
        this._core.trigger("play", null, "video"),
        i = this._core.items(this._core.relative(i.index())),
        this._core.reset(i.index()),
        (e = u('<iframe frameborder="0" allowfullscreen mozallowfullscreen webkitAllowFullScreen ></iframe>')).attr("height", s),
        e.attr("width", o),
        "youtube" === n.type ? e.attr("src", "//www.youtube.com/embed/" + n.id + "?autoplay=1&rel=0&v=" + n.id) : "vimeo" === n.type ? e.attr("src", "//player.vimeo.com/video/" + n.id + "?autoplay=1") : "vzaar" === n.type && e.attr("src", "//view.vzaar.com/" + n.id + "/player?autoplay=true"),
        u(e).wrap('<div class="owl-video-frame" />').insertAfter(i.find(".owl-video")),
...
function(s) {
    ...
    e.prototype.initialize = function() {
        ...
        this._controls.$absolute.on("click", "button", s.proxy(function(t) {
    ...
    e.prototype.draw = function() {
        var t, e = this._core.settings, i = this._core.items().length <= e.items, n = this._core.relative(this._core.current()), o = e.loop || e.rewind;
        this._controls.$relative.toggleClass("disabled", !e.nav || i),
        e.nav && (this._controls.$previous.toggleClass("disabled", !o && n <= this._core.minimum(!0)),
    ...
    e.prototype.getPosition = function(t) {
        ...
        return "page" == n.slideBy ? (e = s.inArray(this.current(), this._pages),
    ...
    e.prototype.to = function(t, e, i) {
        ...
        s.proxy(this._overrides.to, this._core)(this._pages[(t % n + n) % n].start, e)) : s.proxy(this._overrides.to, this._core)(t, e)
    }
    ,
...
function(o, s) {
    ...
    !function() {
        return !!l("transition")
    }() || (o.support.transition = new String(c("transition")),
    o.support.transition.end = t.transition.end[o.support.transition]),
    n() && (o.support.animation = new String(c("animation")),
    o.support.animation.end = t.animation.end[o.support.animation]),
    e() && (o.support.transform = new String(c("transform")),
    o.support.transform3d = i())
}(window.Zepto || window.jQuery, (window,
void document)),
function(i) {
    "use strict";
    i.fn.counterUp = function(t) {
        ...
        return this.each(function() {
            var l = i(this)
              , c = e;
            l.waypoint(function() {
                for (var t = [], e = c.time / c.delay, i = l.text(), n = /[0-9]+,[0-9]+/.test(i), i = i.replace(/,/g, ""), o = (/^[0-9]+$/.test(i),
                /^[0-9]+\.[0-9]+$/.test(i)), s = o ? (i.split(".")[1] || []).length : 0, r = e; 1 <= r; r--) {
                    var a = parseInt(i / e * r);
                    if (o && (a = parseFloat(i / e * r).toFixed(s)),
                    n)
...
function(g, o, t, m) {
    var n = "stellar"
      ...
      , s = function() {
        ...
        return "WebkitOpacity"in i && (n = "Webkit"),
    ...
    c.prototype = {
        ...
        _defineElements: function() {
            ...
            this.$element = this.element === o ? g("body") : this.$scrollElement,
            this.$viewportElement = this.options.viewportElement !== m ? g(this.options.viewportElement) : this.$scrollElement[0] === o || "scroll" === this.options.scrollProperty ? this.$scrollElement : this.$scrollElement.parent()
        },
        ...
        _defineSetters: function() {
            ...
            : g.noop,
            this._setScrollTop = "function" == typeof i ? function(t) {
                i(s.$scrollElement, t)
            }
            : g.noop,
            this._setPosition = r.setPosition || function(t, e, i, n, o) {
                s.options.horizontalScrolling && r.setLeft(t, e, i),
                s.options.verticalScrolling && r.setTop(t, n, o)
            }
        },
        _handleWindowLoadAndResize: function() {
            ...
            e.bind("resize." + this.name, function() {
                t._detectViewport(),
                t.options.responsive && t.refresh()
            })
        },
        refresh: function(t) {
            var i = this
            ...
            t && t.firstLoad && /WebKit/.test(navigator.userAgent) && g(o).on("load", function() {
        ...
        _findParticles: function() {
            ...
            this.particles = [],
            this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function(t) {
                var e, i, n, o, s, r, a, l, c, u = g(this), h = 0, d = 0, p = 0, A = 0;
                if (u.data("stellar-elementIsActive")) {
                    if (u.data("stellar-elementIsActive") !== this)
                        return
                } else
                    u.data("stellar-elementIsActive", this);
                f.options.showElement(u),
                u.data("stellar-startingLeft") ? (u.css("left", u.data("stellar-startingLeft")),
                u.css("top", u.data("stellar-startingTop"))) : (u.data("stellar-startingLeft", u.css("left")),
                u.data("stellar-startingTop", u.css("top"))),
                n = u.position().left,
                o = u.position().top,
                s = "auto" === u.css("margin-left") ? 0 : parseInt(u.css("margin-left"), 10),
                r = "auto" === u.css("margin-top") ? 0 : parseInt(u.css("margin-top"), 10),
                l = u.offset().left - s,
                c = u.offset().top - r,
                ...
                e = u.data("stellar-horizontal-offset") !== m ? u.data("stellar-horizontal-offset") : a !== m && a.data("stellar-horizontal-offset") !== m ? a.data("stellar-horizontal-offset") : f.horizontalOffset,
                i = u.data("stellar-vertical-offset") !== m ? u.data("stellar-vertical-offset") : a !== m && a.data("stellar-vertical-offset") !== m ? a.data("stellar-vertical-offset") : f.verticalOffset,
                f.particles.push({
                    $element: u,
                    $offsetParent: a,
                    ...
                    parentOffsetLeft: h,
                    parentOffsetTop: d,
                    stellarRatio: u.data("stellar-ratio") !== m ? u.data("stellar-ratio") : 1,
        ...
        _findBackgrounds: function() {
            var t, p = this, A = this._getScrollLeft(), f = this._getScrollTop();
            this.backgrounds = [],
            this.options.parallaxBackgrounds && (t = this.$element.find("[data-stellar-background-ratio]"),
            this.$element.data("stellar-background-ratio") && (t = t.add(this.$element)),
            t.each(function() {
                var t, e, i, n, o, s, r, a = g(this), l = y(a), c = 0, u = 0, h = 0, d = 0;
                if (a.data("stellar-backgroundIsActive")) {
                    if (a.data("stellar-backgroundIsActive") !== this)
                        return
                } else
                    a.data("stellar-backgroundIsActive", this);
                a.data("stellar-backgroundStartingLeft") ? v(a, a.data("stellar-backgroundStartingLeft"), a.data("stellar-backgroundStartingTop")) : (a.data("stellar-backgroundStartingLeft", l[0]),
                a.data("stellar-backgroundStartingTop", l[1])),
                i = "auto" === a.css("margin-left") ? 0 : parseInt(a.css("margin-left"), 10),
                n = "auto" === a.css("margin-top") ? 0 : parseInt(a.css("margin-top"), 10),
                o = a.offset().left - i - A,
                s = a.offset().top - n - f,
                ...
                t = a.data("stellar-horizontal-offset") !== m ? a.data("stellar-horizontal-offset") : r !== m && r.data("stellar-horizontal-offset") !== m ? r.data("stellar-horizontal-offset") : p.horizontalOffset,
                e = a.data("stellar-vertical-offset") !== m ? a.data("stellar-vertical-offset") : r !== m && r.data("stellar-vertical-offset") !== m ? r.data("stellar-vertical-offset") : p.verticalOffset,
                p.backgrounds.push({
                    $element: a,
                    $offsetParent: r,
                    ...
                    parentOffsetLeft: c,
                    parentOffsetTop: u,
                    stellarRatio: a.data("stellar-background-ratio") === m ? 1 : a.data("stellar-background-ratio")
                })
            }))
        },
        _reset: function() {
            ...
            for (o = this.backgrounds.length - 1; 0 <= o; o--)
                ...
                v(n.$element, n.startingValueLeft, n.startingValueTop)
        },
        destroy: function() {
            this._reset(),
            this.$scrollElement.unbind("resize." + this.name).unbind("scroll." + this.name),
            this._animationLoop = g.noop,
            g(o).unbind("load." + this.name).unbind("resize." + this.name)
        },
        ...
        _repositionElements: function() {
            var t, e, i, n, o, s, r, a, l, c, u = this._getScrollLeft(), h = this._getScrollTop(), d = !0, p = !0;
            if (this.currentScrollLeft !== u || this.currentScrollTop !== h || this.currentWidth !== this.viewportWidth || this.currentHeight !== this.viewportHeight) {
                ...
                c = this.particles.length - 1; 0 <= c; c--)
                    e = (t = this.particles[c]).isFixed ? 1 : 0,
                    a = this.options.horizontalScrolling ? (s = (u + t.horizontalOffset + this.viewportOffsetLeft + t.startingPositionLeft - t.startingOffsetLeft + t.parentOffsetLeft) * -(t.stellarRatio + e - 1) + t.startingPositionLeft) - t.startingPositionLeft + t.startingOffsetLeft : (s = t.startingPositionLeft,
                    t.startingOffsetLeft),
                    l = this.options.verticalScrolling ? (r = (h + t.verticalOffset + this.viewportOffsetTop + t.startingPositionTop - t.startingOffsetTop + t.parentOffsetTop) * -(t.stellarRatio + e - 1) + t.startingPositionTop) - t.startingPositionTop + t.startingOffsetTop : (r = t.startingPositionTop,
                    t.startingOffsetTop),
                    this.options.hideDistantElements && (p = !this.options.horizontalScrolling || a + t.width > (t.isFixed ? 0 : u) && a < (t.isFixed ? 0 : u) + this.viewportWidth + this.viewportOffsetLeft,
                    d = !this.options.verticalScrolling || l + t.height > (t.isFixed ? 0 : h) && l < (t.isFixed ? 0 : h) + this.viewportHeight + this.viewportOffsetTop),
                    p && d ? (t.isHidden && (this.options.showElement(t.$element),
                    t.isHidden = !1),
                ...
                for (c = this.backgrounds.length - 1; 0 <= c; c--)
                    ...
                    n = this.options.horizontalScrolling ? (u + i.horizontalOffset - this.viewportOffsetLeft - i.startingOffsetLeft + i.parentOffsetLeft - i.startingBackgroundPositionLeft) * (e - i.stellarRatio) + "px" : i.startingValueLeft,
        ...
        _handleScrollEvent: function() {
            ...
            var i = this
              , n = !1;
            this.$scrollElement.bind("scroll." + this.name, e),
            e()
        },
    ...
    ,
    g[n].scrollProperty = a,
    g[n].positionProperty = l,
    o.Stellar = c
    ...
    i.prototype.handleScroll = function() {
        ...
        for (var i in e) {
            ...
            for (var s in this.waypoints[i]) {
                var r, a, l = this.waypoints[i][s];
                null !== l.triggerPoint && (r = n.oldScroll < l.triggerPoint,
                a = n.newScroll >= l.triggerPoint,
                (r && a || !r && !a) && (l.queueTrigger(o),
    ...
    i.prototype.refresh = function() {
        ...
        t = {
            ...
            for (var r in this.waypoints[o]) {
                var a, l, c, u, h = this.waypoints[o][r], d = h.options.offset, p = h.triggerPoint, A = 0, f = null == p;
                h.element !== h.element.window && (A = h.adapter.offset()[s.offsetProp]),
                "function" == typeof d ? d = d.apply(h) : "string" == typeof d && (d = parseFloat(d),
                -1 < h.options.offset.indexOf("%") && (d = Math.ceil(s.contextDimension * d / 100))),
                a = s.contextScroll - s.contextOffset,
                h.triggerPoint = Math.floor(A + a - d),
                l = p < s.oldScroll,
                c = h.triggerPoint >= s.oldScroll,
                u = !l && !c,
                !f && (l && c) ? (h.queueTrigger(s.backward),
                n[h.group.id] = h.group) : (!f && u || f && s.oldScroll >= h.triggerPoint) && (h.queueTrigger(s.forward),
                n[h.group.id] = h.group)
            }
        }
    ...
    function t(n) {
        return function() {
            ...
            this.each(function() {
                ...
                "string" == typeof t.context && (t.context = n(this).closest(t.context)[0]),
                e.push(new o(t))
            }),
            e
        }
...
function(u) {
    ...
    u.fn.countdown = function(t, r) {
        ...
        function e() {
            ...
            i -= 60 * s,
            1 == n ? a.find(".timeRefDays").text("day") : a.find(".timeRefDays").text("days"),
            1 == o ? a.find(".timeRefHours").text("hour") : a.find(".timeRefHours").text("hours"),
            1 == s ? a.find(".timeRefMinutes").text("minute") : a.find(".timeRefMinutes").text("minutes"),
            1 == i ? a.find(".timeRefSeconds").text("second") : a.find(".timeRefSeconds").text("seconds"),
            "on" == l.format && (n = 2 <= String(n).length ? n : "0" + n,
            o = 2 <= String(o).length ? o : "0" + o,
            s = 2 <= String(s).length ? s : "0" + s,
            i = 2 <= String(i).length ? i : "0" + i),
            isNaN(t) ? (alert("Invalid date. Here's an example: 12 Tuesday 2012 17:30:00"),
            clearInterval(c)) : (a.find(".days").text(n),
            a.find(".hours").text(o),
            a.find(".minutes").text(s),
            a.find(".seconds").text(i))
        }
        t && u.extend(l, t),
        e();
...
function(t) {
    ...
    function p(t, e) {
        ...
        f.st.callbacks[t] && f.st.callbacks[t].apply(f, u.isArray(e) ? e : [e]))
    }
    function A(t) {
        return t === e && f.currTemplate.closeBtn || (f.currTemplate.closeBtn = u(f.st.closeMarkup.replace("%title%", f.st.tClose)),
        e = t),
        f.currTemplate.closeBtn
    }
    function s() {
        u.magnificPopup.instance || ((f = new t).init(),
        u.magnificPopup.instance = f)
    }
    var f, n, g, o, m, e, a = "Close", l = "BeforeClose", v = "MarkupParse", y = "Open", i = ".mfp", w = "mfp-ready", r = "mfp-removing", c = "mfp-prevent-close", _ = !!window.jQuery, b = u(window);
    t.prototype = {
        constructor: t,
        init: function() {
        ...
        open: function(t) {
            if (!1 === t.isObj) {
                ...
                for (var e, i = t.items, n = 0; n < i.length; n++)
                    if ((e = i[n]).parsed && (e = e.el[0]),
                    e === t.el[0]) {
                        f.index = n;
                        break
                    }
            } else
                f.items = u.isArray(t.items) ? t.items : [t.items],
                f.index = t.index || 0;
            if (!f.isOpen) {
                f.types = [],
                m = "",
                t.mainEl && t.mainEl.length ? f.ev = t.mainEl.eq(0) : f.ev = g,
                t.key ? (f.popupsCache[t.key] || (f.popupsCache[t.key] = {}),
                f.currTemplate = f.popupsCache[t.key]) : f.currTemplate = {},
                f.st = u.extend(!0, {}, u.magnificPopup.defaults, t),
                ...
                f.bgOverlay || (f.bgOverlay = d("bg").on("click.mfp", function() {
                    f.close()
                }),
                f.wrap = d("wrap").attr("tabindex", -1).on("click.mfp", function(t) {
                ...
                p("BeforeOpen"),
                f.st.showCloseBtn && (f.st.closeBtnInside ? (h(v, function(t, e, i, n) {
                    i.close_replaceWith = A(n.type)
                }),
                m += " mfp-close-btn-in") : f.wrap.append(A())),
                f.st.alignTop && (m += " mfp-align-top"),
                ...
                f.st.enableEscapeKey && g.on("keyup.mfp", function(t) {
                    27 === t.keyCode && f.close()
                }),
                b.on("resize.mfp", function() {
                    f.updateSize()
                }),
                f.st.closeOnContentClick || (m += " mfp-auto-cursor"),
                m && f.wrap.addClass(m);
                var r, a = f.wH = b.height(), l = {};
                f.fixedContentPos && f._hasScrollBar(a) && ((r = f._getScrollbarSize()) && (l.marginRight = r)),
                f.fixedContentPos && (f.isIE7 ? u("body, html").css("overflow", "hidden") : l.overflow = "hidden");
                var c = f.st.mainClass;
                return f.isIE7 && (c += " mfp-ie7"),
                c && f._addClassToMFP(c),
                f.updateItemHTML(),
                p("BuildControls"),
                u("html").css(l),
                f.bgOverlay.add(f.wrap).prependTo(f.st.prependTo || u(document.body)),
                f._lastFocusedEl = document.activeElement,
                setTimeout(function() {
                    f.content ? (f._addClassToMFP(w),
                    f._setFocus()) : f.bgOverlay.addClass(w),
                    g.on("focusin.mfp", f._onFocusIn)
                }, 16),
                f.isOpen = !0,
                f.updateSize(a),
                p(y),
        ...
        _close: function() {
            ...
            f.isIE7 ? u("body, html").css("overflow", "") : t.overflow = "",
            u("html").css(t)),
            ...
            f.st.autoFocusLast && f._lastFocusedEl && u(f._lastFocusedEl).focus(),
            f.currItem = null,
            f.content = null,
            f.currTemplate = null,
            f.prevHeight = 0,
        ...
        updateItemHTML: function() {
            ...
            var e, i = t.type;
            p("BeforeChange", [f.currItem ? f.currItem.type : "", i]),
            f.currItem = t,
            f.currTemplate[i] || (e = !!f.st[i] && f.st[i].markup,
            p("FirstMarkupParse", e),
            f.currTemplate[i] = !e || u(e)),
            o && o !== t.type && f.container.removeClass("mfp-" + o + "-holder");
            var n = f["get" + i.charAt(0).toUpperCase() + i.slice(1)](t, f.currTemplate[i]);
            f.appendContent(n, i),
            t.preloaded = !0,
            p("Change", t),
            o = t.type,
        ...
        appendContent: function(t, e) {
            (f.content = t) ? f.st.showCloseBtn && f.st.closeBtnInside && !0 === f.currTemplate[e] ? f.content.find(".mfp-close").length || f.content.append(A()) : f.content = t : f.content = "",
            p("BeforeAppend"),
        ...
        _checkIfClose: function(t) {
            if (!u(t).hasClass(c)) {
                ...
                if (e && i)
                    return !0;
                if (!f.content || u(t).hasClass("mfp-close") || f.preloader && t === f.preloader[0])
                    return !0;
                if (t === f.content[0] || u.contains(f.content[0], t)) {
                    if (e)
                        return !0
                } else if (i && u.contains(document, t))
                    return !0;
                return !1
            }
        },
        ...
        _hasScrollBar: function(t) {
            return (f.isIE7 ? g.height() : document.body.scrollHeight) > (t || b.height())
        },
        _setFocus: function() {
            (f.st.focus ? f.content.find(f.st.focus).eq(0) : f.wrap).focus()
        },
        _onFocusIn: function(t) {
            return t.target === f.wrap[0] || u.contains(f.wrap[0], t.target) ? void 0 : (f._setFocus(),
            !1)
        },
        _parseMarkup: function(o, t, e) {
            ...
            u.each(t, function(t, e) {
                return void 0 === e || !1 === e || void (1 < (s = t.split("_")).length ? 0 < (i = o.find(".mfp-" + s[0])).length && ("replaceWith" === (n = s[1]) ? i[0] !== e[0] && i.replaceWith(e) : "img" === n ? i.is("img") ? i.attr("src", e) : i.replaceWith(u("<img>").attr("src", e).attr("class", i.attr("class"))) : i.attr(s[1], e)) : o.find(".mfp-" + t).html(e));
                var i, n
            })
        },
    ...
    u.fn.magnificPopup = function(t) {
        ...
        e.delegate && (n = n.find(e.delegate)),
        n.eq(i)),
        f._openClick({
            mfpEl: n
        }, o, e)) : f.isOpen && f[t].apply(f, Array.prototype.slice.call(arguments, 1)) : (t = u.extend(!0, {}, t),
    ...
    u.magnificPopup.registerModule(D, {
        ...
        proto: {
            ...
            getInline: function(t, e) {
                if (E(),
                t.src) {
                    var i, n = f.st.inline, o = u(t.src);
                    return o.length ? ((i = o[0].parentNode) && i.tagName && (C || (x = n.hiddenClass,
                    C = d(x),
                    x = "mfp-" + x),
                    T = o.after(C).detach().removeClass(x)),
                    f.updateStatus("ready")) : (f.updateStatus("error", n.tNotFound),
                    o = u("<div>")),
                    t.inlineElement = o
                }
    ...
    u.magnificPopup.registerModule("image", {
        ...
        proto: {
            initImage: function() {
                ...
                f.types.push("image"),
                h(y + e, function() {
                    "image" === f.currItem.type && t.cursor && u(document.body).addClass(t.cursor)
                }),
                h(a + e, function() {
                    t.cursor && u(document.body).removeClass(t.cursor),
                    b.off("resize.mfp")
                }),
                h("Resize" + e, f.resizeImage),
                f.isLowIE && h("AfterChange", f.resizeImage)
            },
                ...
                var i = 0
                  ...
                  , o = function(t) {
                    ...
                    B = setInterval(function() {
                        return 0 < n.naturalWidth ? void f._onImageHasSize(e) : (200 < i && clearInterval(B),
            ...
            getImage: function(t, e) {
                ...
                return a.length && ((i = document.createElement("img")).className = "mfp-img",
                t.el && t.el.find("img").length && (i.alt = t.el.find("img").attr("alt")),
                t.img = u(i).on("load.mfploader", o).on("error.mfploader", s),
                i.src = t.src,
    ...
    u.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            ...
            _getOffset: function(t) {
                ...
                z ? s["-moz-transform"] = s.transform = "translate(" + i.left + "px," + i.top + "px)" : (s.left = i.left,
                s.top = i.top),
                s
            }
        }
        ...
        proto: {
            initGallery: function() {
                ...
                h("UpdateStatus" + t, function(t, e) {
                    e.text && (e.text = Q(e.text, f.currItem.index, f.items.length))
                }),
                h(v + t, function(t, e, i, n) {
                    var o = f.items.length;
                    i.counter = 1 < o ? Q(s.tCounter, n.index, o) : ""
                }),
                h("BuildControls" + t, function() {
                    var t, e, i;
                    1 < f.items.length && s.arrows && !f.arrowLeft && (t = s.arrowMarkup,
                    e = f.arrowLeft = u(t.replace(/%title%/gi, s.tPrev).replace(/%dir%/gi, "left")).addClass(c),
                    i = f.arrowRight = u(t.replace(/%title%/gi, s.tNext).replace(/%dir%/gi, "right")).addClass(c),
                    e.click(function() {
                        f.prev()
                    }),
                    i.click(function() {
            ...
            _preloadItem: function(t) {
                ...
                p("LazyLoad", e),
                "image" === e.type && (e.img = u('<img class="mfp-img" />').on("load.mfploader", function() {
                    e.hasSize = !0
    ...
    u.magnificPopup.registerModule(M, {
        ...
        proto: {
            initRetina: function() {
                ...
                n = i.ratio,
                1 < (n = isNaN(n) ? n() : n) && (h("ImageHasSize." + M, function(t, e) {
                    e.img.css({
                        "max-width": e.img[0].naturalWidth / n,
                        width: "100%"
                    })
                }),
                h("ElementParse." + M, function(t, e) {
    ...
    function i(c, o, u) {
        ...
        u.fn[c] = function(t) {
            if ("string" != typeof t)
                ...
                this;
            var e, s, r, a, l, n, i = h.call(arguments, 1);
            return r = i,
            l = "$()." + c + '("' + (s = t) + '")',
            (e = this).each(function(t, e) {
                var i, n, o = u.data(e, c);
                o ? (i = o[s]) && "_" != s.charAt(0) ? (n = i.apply(o, r),
                a = void 0 === a ? n : a) : d(l + " is not a valid method") : d(c + " not initialized. Cannot call methods, i.e. " + l)
            }),
            void 0 !== a ? a : e
        }
        ,
...
function(t, e) {
    ...
    function b(t) {
        ...
        (v = document.body || document.documentElement).appendChild(m),
        y = _(m),
        b.isBoxSizeOuter = E = 200 == w(y.width),
        v.removeChild(m)),
        ...
        t && "object" == typeof t && t.nodeType) {
            ...
            var l = i.paddingLeft + i.paddingRight
              ...
              , A = n && E
              , f = w(e.width);
            !1 !== f && (i.width = f + (A ? 0 : l + d));
            var g = w(e.height);
            return !1 !== g && (i.height = g + (A ? 0 : c + p)),
    ...
    var E, i = "undefined" == typeof console ? function() {}
    : function(t) {
        console.error(t)
    }
    , x = ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom", "marginLeft", "marginRight", "marginTop", "marginBottom", "borderLeftWidth", "borderRightWidth", "borderTopWidth", "borderBottomWidth"], C = x.length, T = !1;
    return b
}),
function(t, e) {
    "use strict";
...
function(t, e) {
    ...
    l._transitionTo = function(t, e) {
        this.getPosition();
        var i, n, o, s = this.position.x, r = this.position.y, a = parseInt(t, 10), l = parseInt(e, 10), c = a === this.position.x && l === this.position.y;
        this.setPosition(t, e),
        !c || this.isTransitioning ? (i = t - s,
        n = e - r,
...
function(t, e) {
    ...
    o.getSegmentSize = function(t, e) {
        var i, n = t + e, o = "outer" + e;
        this._getMeasurement(n, o),
        this[n] || (i = this.getFirstItemSize(),
        this[n] = i && i[o] || this.isotope.size["inner" + e])
    }
    ,
...
function(r, a) {
    ...
    var h = function(t) {
        if ("string" != typeof t)
            return t;
        var e, i, n = c(t).split(" "), o = n[0], s = o.match(/^\[(.+)\]$/), r = s && s[1], a = (i = o,
        (e = r) ? function(t) {
...
function(Tt) {
    function s(s, t) {
        this.xzoom = !0;
        var e, r, a, l, c, i, o, u, n, h, d, p, A, f, g, m, v, y, w, _, b, E, x, C, T, D, P, S, I, k, B, z, N, O, R, Q, M, L, j, q, H, F, W, V, U, Y, Z, G, $, X, J, K = this, tt = {}, et = (new Array,
        new Array), it = 0, nt = 0, ot = 0, st = 0, rt = 0, at = 0, lt = 0, ct = 0, ut = 0, ht = 0, dt = 0, pt = 0, At = 0, ft = detect_old_ie(), gt = /MSIE (\d+\.\d+);/.test(navigator.userAgent), mt = "";
        function vt() {
        ...
        function yt() {
            var t;
            "circle" == K.options.lensShape && "lens" == K.options.position && (t = ((T = D = Math.max(T, D)) + 2 * Math.max(k, I)) / 2,
            x.css({
                "-moz-border-radius": t,
        ...
        function wt(t, e, i, n) {
            ...
            K.options.bg && (x.css({
                ...
                "background-position": -(t - u) * B + T / 2 + "px " + (-(e - o) * z + D / 2) + "px"
            }),
            i && n && x.css({
        ...
        function _t(t, e) {
            ...
            ot < -1 && (ot = -1),
            1 < ot && (ot = 1),
            N < O ? n = (i = l * (N - (N - 1) * ot)) / R : i = (n = c * (O - (O - 1) * ot)) * R,
            L ? (st = t,
            rt = e,
            at = i,
            lt = n) : (L || (ct = at = i,
        ...
        function bt() {
            var t = ht
              ...
              , o = ct
              , s = ut;
            t += (st - t) / K.options.smoothLensMove,
            e += (rt - e) / K.options.smoothLensMove,
            i += (st - i) / K.options.smoothZoomMove,
            n += (rt - n) / K.options.smoothZoomMove,
            o += (at - o) / K.options.smoothScale,
            s += (lt - s) / K.options.smoothScale,
            T = l / (B = o / r),
            D = c / (z = s / a),
            yt(),
            Et(t, e),
            ...
            ct = o,
            ut = s,
            L && requestAnimFrame(bt)
        }
        function Et(t, e) {
            P = (t -= u) - T / 2,
            S = (e -= o) - D / 2,
            "lens" != K.options.position && K.options.lensCollision && (P < 0 && (P = 0),
            T <= r && r - T < P && (P = r - T),
            r < T && (P = r / 2 - T / 2),
            S < 0 && (S = 0),
            D <= a && a - D < S && (S = a - D),
        ...
        this.adaptive = function() {
            ...
            Y < G && (G = Y),
            Z < $ && ($ = Z),
            (V < Y || U < Z ? !0 : !1) ? s.width("100%") : 0 != Y && s.width(Y),
            "fullscreen" != X && (!function() {
                var t = s.offset();
                l = "auto" == K.options.zoomWidth ? G : K.options.zoomWidth;
                c = "auto" == K.options.zoomHeight ? $ : K.options.zoomHeight;
                "#" == K.options.position.substr(0, 1) ? tt = Tt(K.options.position) : tt.length = 0;
                if (0 != tt.length)
                    return !0;
                switch (X) {
                case "lens":
                ...
                return !(V < h + l || h < 0)
            }() ? K.options.position = K.options.mposition : K.options.position = X),
            K.options.lensReverse || (J = K.options.adaptiveReverse && K.options.position == K.options.mposition)
        }
        ,
        this.xscroll = function(t) {
            var e, i, n;
            A = t.pageX || t.originalEvent.pageX,
            f = t.pageY || t.originalEvent.pageY,
            t.preventDefault(),
            t.xscale ? (ot = t.xscale,
            _t(A, f)) : (e = -t.originalEvent.detail || t.originalEvent.wheelDelta || t.xdelta,
            i = A,
            n = f,
            ft && (i = j,
            n = q),
        ...
        this.openzoom = function(t) {
            switch (A = t.pageX,
            f = t.pageY,
            K.options.adaptive && K.adaptive(),
            ot = K.options.defaultScale,
            L = !1,
            g = Tt("<div></div>"),
            "" != K.options.sourceClass && g.addClass(K.options.sourceClass),
            g.css("position", "absolute"),
            y = Tt("<div></div>"),
            "" != K.options.loadingClass && y.addClass(K.options.loadingClass),
            y.css("position", "absolute"),
            m = Tt('<div style="position: absolute; top: 0; left: 0;"></div>'),
            g.append(y),
            v = Tt("<div></div>"),
            "" != K.options.zoomClass && "fullscreen" != K.options.position && v.addClass(K.options.zoomClass),
            v.css({
                position: "absolute",
                overflow: "hidden",
                opacity: 1
            }),
            K.options.title && "" != mt && (W = Tt("<div></div>"),
            F = Tt("<div></div>"),
            W.css({
                position: "absolute",
                opacity: 1
            }),
            K.options.titleClass && F.addClass(K.options.titleClass),
            F.html("<span>" + mt + "</span>"),
            W.append(F),
            K.options.fadeIn && W.css({
                opacity: 0
            })),
            x = Tt("<div></div>"),
            "" != K.options.lensClass && x.addClass(K.options.lensClass),
            x.css({
                position: "absolute",
                overflow: "hidden"
            }),
            K.options.lens && (lenstint = Tt("<div></div>"),
            lenstint.css({
                position: "absolute",
                background: K.options.lens,
                opacity: K.options.lensOpacity,
                width: "100%",
                height: "100%",
                top: 0,
                left: 0,
            ...
            x.append(lenstint)),
            function() {
                switch (a = "fullscreen" == K.options.position ? (r = Tt(window).width(),
                Tt(window).height()) : (r = s.width(),
                s.height()),
                y.css({
                    top: a / 2 - y.height() / 2,
                    left: r / 2 - y.width() / 2
                }),
                (i = K.options.rootOutput || "fullscreen" == K.options.position ? s.offset() : s.position()).top = Math.round(i.top),
                ...
                u -= g.outerWidth() / 2,
                "#" == K.options.position.substr(0, 1) ? tt = Tt(K.options.position) : tt.length = 0,
                0 == tt.length && "inside" != K.options.position && "fullscreen" != K.options.position ? (K.options.adaptive && Y && Z || (Y = r,
                Z = a),
                l = "auto" == K.options.zoomWidth ? r : K.options.zoomWidth,
                c = "auto" == K.options.zoomHeight ? a : K.options.zoomHeight,
                n += K.options.Yoffset,
                h += K.options.Xoffset,
                v.css({
                    width: l + "px",
                ...
                "lens" != K.options.position && e.append(v)) : "inside" == K.options.position || "fullscreen" == K.options.position ? (l = r,
                c = a,
                v.css({
                    width: l + "px",
                    height: c + "px"
                }),
                g.append(v)) : (l = tt.width(),
                c = tt.height(),
                K.options.rootOutput ? (n = tt.offset().top,
                h = tt.offset().left,
                e.append(v)) : (n = tt.position().top,
                h = tt.position().left,
                tt.parent().append(v)),
                n += (tt.outerHeight() - c - v.outerHeight()) / 2,
                h += (tt.outerWidth() - l - v.outerWidth()) / 2,
                v.css({
                    width: l + "px",
                    height: c + "px",
                    top: n,
                ...
                K.options.title && "" != mt && ("inside" == K.options.position || "lens" == K.options.position || "fullscreen" == K.options.position ? (d = n,
                p = h,
                g.append(W)) : (d = n + (v.outerHeight() - c) / 2,
                p = h + (v.outerWidth() - l) / 2,
                e.append(W)),
                W.css({
                    width: l + "px",
                    height: c + "px",
                ...
                K.options.tint && "inside" != K.options.position && "fullscreen" != K.options.position ? m.css("background-color", K.options.tint) : ft && m.css({
                    "background-image": "url(" + s.attr("src") + ")",
                    "background-color": "#fff"
                }),
                b = new Image;
                var t = "";
                switch (gt && (t = "?r=" + (new Date).getTime()),
                b.src = s.attr("xoriginal") + t,
                (E = Tt(b)).css("position", "absolute"),
                (b = new Image).src = s.attr("src"),
                (C = Tt(b)).css("position", "absolute"),
                C.width(r),
                K.options.position) {
                case "fullscreen":
                case "inside":
            ...
            "inside" != K.options.position && "fullscreen" != K.options.position ? ((K.options.tint || ft) && g.append(m),
            K.options.fadeIn && (m.css({
                opacity: 0
            }),
            x.css({
                opacity: 0
            ...
            case "inside":
                ...
                h -= (v.outerWidth() - v.width()) / 2;
                break;
            case "top":
                n -= v.outerHeight() - v.height(),
                h -= (v.outerWidth() - v.width()) / 2;
                break;
            case "left":
                n -= (v.outerHeight() - v.height()) / 2,
                h -= v.outerWidth() - v.width();
                break;
            case "bottom":
                h -= (v.outerWidth() - v.width()) / 2;
                break;
            ...
            E.xon("load", function(t) {
                if (y.remove(),
                !K.options.openOnSmall && (E.width() < l || E.height() < c))
                    return K.closezoom(),
                    t.preventDefault(),
                    !1;
                K.options.scroll && K.eventscroll(g),
                "inside" != K.options.position && "fullscreen" != K.options.position ? (g.append(x),
                K.options.fadeIn ? (m.fadeTo(300, K.options.tintOpacity),
                x.fadeTo(300, 1),
                v.fadeTo(300, 1)) : (m.css({
                    opacity: K.options.tintOpacity
                }),
                x.css({
                    opacity: 1
                }),
                v.css({
                    opacity: 1
                }))) : K.options.fadeIn ? v.fadeTo(300, 1) : v.css({
                    opacity: 1
                }),
                K.options.title && "" != mt && (K.options.fadeIn ? W.fadeTo(300, 1) : W.css({
                    opacity: 1
                })),
                Q = E.width(),
                M = E.height(),
                K.options.adaptive && (r < Y || a < Z) && (C.width(r),
                C.height(a),
                Q *= r / Y,
                M *= a / Z,
                E.width(Q),
                ...
                N = Q / l,
                O = M / c;
                for (var e, i = ["padding-", "border-"], n = k = I = 0; n < i.length; n++)
                    e = parseFloat(x.css(i[n] + "top-width")),
                    k += e != e ? 0 : e,
                    e = parseFloat(x.css(i[n] + "bottom-width")),
                    k += e != e ? 0 : e,
                    e = parseFloat(x.css(i[n] + "left-width")),
                    I += e != e ? 0 : e,
                    e = parseFloat(x.css(i[n] + "right-width")),
                    I += e != e ? 0 : e;
                k /= 2,
                I /= 2,
                pt = ht = st = A,
        ...
        this.movezoom = function(t) {
            ...
            J && (t.pageX -= 2 * (e - r / 2),
            t.pageY -= 2 * (i - a / 2)),
            (e < 0 || r < e || i < 0 || a < i) && g.trigger("mouseleave"),
            K.options.smooth ? (st = t.pageX,
            rt = t.pageY) : (yt(),
            Et(t.pageX, t.pageY),
            x.css({
                top: S - k,
            ...
            wt(t.pageX, t.pageY, 0, 0))
        }
        ,
        this.eventdefault = function() {
            K.eventopen = function(t) {
                t.xon("mouseenter", K.openzoom)
            }
            ,
            K.eventleave = function(t) {
                t.xon("mouseleave", K.closezoom)
            }
            ,
            K.eventmove = function(t) {
                t.xon("mousemove", K.movezoom)
            }
            ,
            K.eventscroll = function(t) {
                t.xon("mousewheel DOMMouseScroll", K.xscroll)
            }
            ,
            K.eventclick = function(t) {
        ...
        this.init = function(t) {
            K.options = Tt.extend({}, Tt.fn.xzoom.defaults, t),
            e = K.options.rootOutput ? Tt("body") : s.parent(),
            X = K.options.position,
            J = K.options.lensReverse && "inside" == K.options.position,
            K.options.smoothZoomMove < 1 && (K.options.smoothZoomMove = 1),
            K.options.smoothLensMove < 1 && (K.options.smoothLensMove = 1),
            K.options.smoothScale < 1 && (K.options.smoothScale = 1),
            K.options.adaptive && Tt(window).xon("load", function() {
                Y = s.width(),
                Z = s.height(),
                K.adaptive(),
                Tt(window).resize(K.adaptive)
            }),
            K.eventdefault(),
            K.eventopen(s)
        }
        ...
        this.closezoom = function() {
            L = !1,
            K.options.fadeOut ? (K.options.title && "" != mt && W.fadeOut(299),
            "inside" == K.options.position && "fullscreen" == K.options.position || v.fadeOut(299),
        ...
        this.gallery = function() {
            for (var t = new Array, e = 0, i = nt; i < et.length; i++)
                t[e] = et[i],
                e++;
            for (i = 0; i < nt; i++)
                t[e] = et[i],
        ...
        this.xappend = function(n) {
            ...
            function t(t) {
                xt(),
                t.preventDefault(),
                K.options.activeClass && (H.removeClass(K.options.activeClass),
                (H = n).addClass(K.options.activeClass)),
                nt = Tt(this).data("xindex"),
                K.options.fadeTrans && ((_ = new Image).src = s.attr("src"),
                (w = Tt(_)).css({
                    position: "absolute",
                    top: s.offset().top,
                    left: s.offset().left,
                ...
                Tt(document.body).append(w),
                w.fadeOut(200, function() {
                    w.remove()
                }));
                var e = o.attr("href")
                  , i = n.attr("xpreview") || n.attr("src");
                mt = Ct(n),
                n.attr("title") && s.attr("title", n.attr("title")),
                s.attr("xoriginal", e),
                s.removeAttr("style"),
                s.attr("src", i),
                K.options.adaptive && (Y = s.width(),
                Z = s.height())
            }
            et[it] = o.attr("href"),
            o.data("xindex", it),
            0 == it && K.options.activeClass && (H = n).addClass(K.options.activeClass),
            0 == it && K.options.title && (mt = Ct(n)),
            it++,
            K.options.hover && o.xon("mouseenter", o, t),
            o.xon("click", o, t)
        }
        ,
        this.init(t)
    }
    Tt.fn.xon = Tt.fn.on || Tt.fn.bind,
    Tt.fn.xoff = Tt.fn.off || Tt.fn.bind,
    Tt.fn.xzoom = function(e) {
        var i, n;
        if (this.selector) {
            ...
            this.each(function(t) {
                if (1 == o.length)
                    if (0 == t) {
                        if (void 0 !== (i = Tt(this)).data("xzoom"))
                            return i.data("xzoom");
                        i.x = new s(i,e)
                    } else
                        void 0 !== i.x && (n = Tt(this),
                        i.x.xappend(n));
                else if (Tt(this).is(o[0]) && 0 == t) {
                    if (void 0 !== (i = Tt(this)).data("xzoom"))
                        return i.data("xzoom");
                    i.x = new s(i,e)
                } else
                    void 0 === i.x || Tt(this).is(o[0]) || (n = Tt(this),
                    i.x.xappend(n))
            })
        } else
            this.each(function(t) {
        ...
        return void 0 !== i && (i.data("xzoom", i.x),
        Tt(i).trigger("xzoom_ready"),
        i.x)
    }
    ,
...
function(t, o) {
    ...
    l.HAS_POINTEREVENTS = navigator.pointerEnabled || navigator.msPointerEnabled,
    l.HAS_TOUCHEVENTS = "ontouchstart"in t,
    l.MOBILE_REGEX = /mobile|tablet|ip(ad|hone|od)|android/i,
    l.NO_MOUSEEVENTS = l.HAS_TOUCHEVENTS && navigator.userAgent.match(l.MOBILE_REGEX),
    l.EVENT_TYPES = {},
    l.DIRECTION_DOWN = "down",
    l.DIRECTION_LEFT = "left",
    l.DIRECTION_UP = "up",
    l.DIRECTION_RIGHT = "right",
    l.POINTER_MOUSE = "mouse",
    l.POINTER_TOUCH = "touch",
    l.POINTER_PEN = "pen",
    l.EVENT_START = "start",
    l.EVENT_MOVE = "move",
    l.EVENT_END = "end",
    ...
    l.plugins = {},
    l.READY = !1,
    l.Instance = function(t, e) {
        var i = this;
        return function() {
            if (!l.READY) {
                for (var t in l.event.determineEventTypes(),
                l.gestures)
                    l.gestures.hasOwnProperty(t) && l.detection.register(l.gestures[t]);
                l.event.onTouch(l.DOCUMENT, l.EVENT_MOVE, l.detection.detect),
                l.event.onTouch(l.DOCUMENT, l.EVENT_END, l.detection.detect),
                l.READY = !0
            }
        }(),
        this.element = t,
        this.enabled = !0,
        this.options = l.utils.extend(l.utils.extend({}, l.defaults), e || {}),
        this.options.stop_browser_behavior && l.utils.stopDefaultBrowserBehavior(this.element, this.options.stop_browser_behavior),
        l.event.onTouch(t, l.EVENT_START, function(t) {
            i.enabled && l.detection.startDetect(i, t)
        }),
        this
    }
    ,
    l.Instance.prototype = {
        on: function(t, e) {
            for (var i = t.split(" "), n = 0; i.length > n; n++)
                this.element.addEventListener(i[n], e, !1);
            return this
        },
        off: function(t, e) {
            for (var i = t.split(" "), n = 0; i.length > n; n++)
                this.element.removeEventListener(i[n], e, !1);
            return this
        },
        trigger: function(t, e) {
            var i = l.DOCUMENT.createEvent("Event");
            i.initEvent(t, !0, !0),
            i.gesture = e;
            var n = this.element;
            return l.utils.hasParent(e.target, n) && (n = e.target),
            n.dispatchEvent(i),
            this
        },
        enable: function(t) {
    ...
    l.event = {
        bindDom: function(t, e, i) {
            for (var n = e.split(" "), o = 0; n.length > o; o++)
                t.addEventListener(n[o], i, !1)
        },
        onTouch: function(n, o, s) {
            var r = this;
            this.bindDom(n, l.EVENT_TYPES[o], function(t) {
                var e, i = t.type.toLowerCase();
                i.match(/mouse/) && u || ((i.match(/touch/) || i.match(/pointerdown/) || i.match(/mouse/) && 1 === t.which) && (c = !0),
                i.match(/touch|pointer/) && (u = !0),
                e = 0,
                c && (l.HAS_POINTEREVENTS && o != l.EVENT_END ? e = l.PointerEvent.updatePointer(o, t) : i.match(/touch/) ? e = t.touches.length : u || (e = i.match(/up/) ? 0 : 1),
                0 < e && o == l.EVENT_END ? o = l.EVENT_MOVE : e || (o = l.EVENT_END),
                e || null === a ? a = t : t = a,
                s.call(l.detection, r.collectEventData(n, o, t)),
                l.HAS_POINTEREVENTS && o == l.EVENT_END && (e = l.PointerEvent.updatePointer(o, t))),
                e || (a = null,
                u = c = !1,
                l.PointerEvent.reset()))
            })
        },
        determineEventTypes: function() {
            var t = l.HAS_POINTEREVENTS ? l.PointerEvent.getEvents() : l.NO_MOUSEEVENTS ? ["touchstart", "touchmove", "touchend touchcancel"] : ["touchstart mousedown", "touchmove mousemove", "touchend touchcancel mouseup"];
            l.EVENT_TYPES[l.EVENT_START] = t[0],
            l.EVENT_TYPES[l.EVENT_MOVE] = t[1],
            l.EVENT_TYPES[l.EVENT_END] = t[2]
        },
        getTouchList: function(t) {
            return l.HAS_POINTEREVENTS ? l.PointerEvent.getTouchList() : t.touches ? t.touches : [{
                identifier: 1,
                pageX: t.pageX,
                pageY: t.pageY,
                target: t.target
        ...
        collectEventData: function(t, e, i) {
            var n = this.getTouchList(i, e)
              , o = l.POINTER_TOUCH;
            return (i.type.match(/mouse/) || l.PointerEvent.matchType(l.POINTER_MOUSE, i)) && (o = l.POINTER_MOUSE),
            {
                center: l.utils.getCenter(n),
    ...
    l.PointerEvent = {
        ...
        getTouchList: function() {
            var e = this
              , i = [];
            return Object.keys(e.pointers).sort().forEach(function(t) {
                i.push(e.pointers[t])
            }),
            i
        },
        updatePointer: function(t, e) {
            return t == l.EVENT_END ? this.pointers = {} : (e.identifier = e.pointerId,
        ...
        matchType: function(t, e) {
            if (!e.pointerType)
                return !1;
            var i = {};
            return i[l.POINTER_MOUSE] = e.pointerType == e.MSPOINTER_TYPE_MOUSE || e.pointerType == l.POINTER_MOUSE,
            i[l.POINTER_TOUCH] = e.pointerType == e.MSPOINTER_TYPE_TOUCH || e.pointerType == l.POINTER_TOUCH,
            i[l.POINTER_PEN] = e.pointerType == e.MSPOINTER_TYPE_PEN || e.pointerType == l.POINTER_PEN,
            i[t]
        },
        getEvents: function() {
    ...
    l.utils = {
        ...
        getDirection: function(t, e) {
            ...
            return Math.abs(t.pageY - e.pageY) <= i ? 0 < t.pageX - e.pageX ? l.DIRECTION_LEFT : l.DIRECTION_RIGHT : 0 < t.pageY - e.pageY ? l.DIRECTION_UP : l.DIRECTION_DOWN
        },
        ...
        isVertical: function(t) {
            return t == l.DIRECTION_UP || t == l.DIRECTION_DOWN
        },
            ...
            if (e && t.style) {
                for (var o = 0; o < n.length; o++)
                    for (var s in e)
                        ...
                        n[o] && (i = n[o] + i.substring(0, 1).toUpperCase() + i.substring(1)),
                        t.style[i] = e[s]);
    ...
    l.detection = {
        ...
        detect: function(t) {
            if (this.current && !this.stopped) {
                ...
                for (var e = this.current.inst.options, i = 0, n = this.gestures.length; i < n; i++) {
                ...
                t.eventType == l.EVENT_END && !t.touches.length - 1 && this.stopDetect(),
                t
            }
        },
        stopDetect: function() {
            this.previous = l.utils.extend({}, this.current),
            this.current = null,
            this.stopped = !0
        },
        extendEventData: function(t) {
            ...
            if (e && (t.touches.length != e.touches.length || t.touches === e.touches)) {
                e.touches = [];
                for (var i = 0, n = t.touches.length; i < n; i++)
                    e.touches.push(l.utils.extend({}, t.touches[i]))
            }
            var o = t.timeStamp - e.timeStamp
              , s = t.center.pageX - e.center.pageX
              , r = t.center.pageY - e.center.pageY
              , a = l.utils.getVelocity(o, s, r);
            return l.utils.extend(t, {
                deltaTime: o,
                deltaX: s,
                deltaY: r,
                velocityX: a.x,
                velocityY: a.y,
                distance: l.utils.getDistance(e.center, t.center),
                angle: l.utils.getAngle(e.center, t.center),
                direction: l.utils.getDirection(e.center, t.center),
                scale: l.utils.getScale(e.touches, t.touches),
                rotation: l.utils.getRotation(e.touches, t.touches),
                startEvent: e
            }),
            t
        },
        register: function(t) {
            var e = t.defaults || {};
            return e[t.name] === o && (e[t.name] = !0),
            l.utils.extend(l.defaults, e, !0),
            t.index = t.index || 1e3,
    ...
    l.gestures.Hold = {
        ...
        handler: function(t, e) {
            ...
            case l.EVENT_START:
                ...
                l.detection.current.name = this.name,
                this.timer = setTimeout(function() {
                    "hold" == l.detection.current.name && e.trigger("hold", t)
    ...
    l.gestures.Tap = {
        ...
        handler: function(t, e) {
            if (t.eventType == l.EVENT_END) {
                var i = l.detection.previous
                  , n = !1;
                ...
                n = !0),
                n && !e.options.tap_always || (l.detection.current.name = "tap",
                e.trigger(l.detection.current.name, t))
            }
        }
    },
    l.gestures.Swipe = {
        ...
        handler: function(t, e) {
            if (t.eventType == l.EVENT_END) {
                if (0 < e.options.swipe_max_touches && t.touches.length > e.options.swipe_max_touches)
                    return;
    ...
    l.gestures.Drag = {
        ...
        triggered: !1,
        handler: function(t, e) {
            if (l.detection.current.name != this.name && this.triggered)
                return e.trigger(this.name + "end", t),
                this.triggered = !1,
                o;
            if (!(0 < e.options.drag_max_touches && t.touches.length > e.options.drag_max_touches))
                switch (t.eventType) {
                case l.EVENT_START:
                    this.triggered = !1;
                    break;
                case l.EVENT_MOVE:
                    if (t.distance < e.options.drag_min_distance && l.detection.current.name != this.name)
                        return;
                    l.detection.current.name = this.name,
                    (l.detection.current.lastEvent.drag_locked_to_axis || e.options.drag_lock_to_axis && e.options.drag_lock_min_distance <= t.distance) && (t.drag_locked_to_axis = !0);
                    var i = l.detection.current.lastEvent.direction;
                    t.drag_locked_to_axis && i !== t.direction && (t.direction = l.utils.isVertical(i) ? t.deltaY < 0 ? l.DIRECTION_UP : l.DIRECTION_DOWN : t.deltaX < 0 ? l.DIRECTION_LEFT : l.DIRECTION_RIGHT),
                    this.triggered || (e.trigger(this.name + "start", t),
                    this.triggered = !0),
                    e.trigger(this.name, t),
                    e.trigger(this.name + t.direction, t),
                    (e.options.drag_block_vertical && l.utils.isVertical(t.direction) || e.options.drag_block_horizontal && !l.utils.isVertical(t.direction)) && t.preventDefault();
                    break;
                case l.EVENT_END:
        ...
        handler: function(t, e) {
            ...
            if (!(t.touches.length < 2))
                ...
                case l.EVENT_MOVE:
                    ...
                    if (e.options.transform_min_scale > i && e.options.transform_min_rotation > n)
                        return;
                    l.detection.current.name = this.name,
                    this.triggered || (e.trigger(this.name + "start", t),
                    this.triggered = !0),
    ...
    l.gestures.Touch = {
        ...
        handler: function(t, e) {
            return e.options.prevent_mouseevents && t.pointerType == l.POINTER_MOUSE ? t.stopDetect() : (e.options.prevent_default && t.preventDefault(),
            t.eventType == l.EVENT_START && e.trigger(this.name, t)),
            o
        }
    },
    l.gestures.Release = {
        ...
        index: 1 / 0,
        handler: function(t, e) {
            t.eventType == l.EVENT_END && e.trigger(this.name, t)
        }
    },
    "object" == typeof module && "object" == typeof module.exports ? module.exports = l : (t.Hammer = l,
...
function(n) {
    "use strict";
    void 0 !== n && (Hammer.event.bindDom = function(t, e, i) {
        n(t).on(e, function(t) {
            var e = t.originalEvent || t;
            void 0 === e.pageX && (e.pageX = t.pageX,
            e.pageY = t.pageY),
            e.target || (e.target = t.target),
            void 0 === e.which && (e.which = e.button),
    ...
    ,
    Hammer.Instance.prototype.on = function(t, e) {
        return n(this.element).on(t, e)
    }
    ,
    Hammer.Instance.prototype.off = function(t, e) {
        return n(this.element).off(t, e)
    }
    ,
    Hammer.Instance.prototype.trigger = function(t, e) {
        var i = n(this.element);
        return i.has(e.target).length && (i = n(e.target)),
        i.trigger({
            type: t,
            gesture: e
        })
    ...
    n.fn.hammer = function(i) {
        return this.each(function() {
            var t = n(this)
              , e = t.data("hammer");
            e ? e && i && Hammer.utils.extend(e.options, i) : t.data("hammer", new Hammer(this,i || {}))
        })
    }
    )
...
function(s) {
    s(document).ready(function() {
        s(".xzoom, .xzoom-gallery").xzoom({
            zoomWidth: 400,
            title: !0,
            tint: "#333",
            Xoffset: 15
        }),
        s(".xzoom2, .xzoom-gallery2").xzoom({
            position: "#xzoom2-id",
            tint: "#ffa200"
        }),
        s(".xzoom3, .xzoom-gallery3").xzoom({
            position: "lens",
            lensShape: "circle",
            sourceClass: "xzoom-hidden"
        }),
        s(".xzoom4, .xzoom-gallery4").xzoom({
            tint: "#232323",
            Xoffset: 15
        }),
        s(".xzoom5, .xzoom-gallery5").xzoom({
            tint: "#232323",
            Xoffset: 15
        }),
        "ontouchstart"in window ? (s(".xzoom, .xzoom2, .xzoom3, .xzoom4, .xzoom5").each(function() {
            s(this).data("xzoom").eventunbind()
        }),
        s(".xzoom, .xzoom2, .xzoom3").each(function() {
            var e = s(this).data("xzoom");
            s(this).hammer().on("tap", function(t) {
                t.pageX = t.gesture.center.pageX,
                t.pageY = t.gesture.center.pageY;
                e.eventmove = function(t) {
                    t.hammer().on("drag", function(t) {
                        t.pageX = t.gesture.center.pageX,
                        t.pageY = t.gesture.center.pageY,
                        e.movezoom(t),
                ...
                ,
                e.eventleave = function(t) {
                    t.hammer().on("tap", function(t) {
                        e.closezoom()
                    })
                }
                ,
        ...
        s(".xzoom4").each(function() {
            var o = s(this).data("xzoom");
            s(this).hammer().on("tap", function(e) {
                e.pageX = e.gesture.center.pageX,
                e.pageY = e.gesture.center.pageY;
                o.eventmove = function(t) {
                    t.hammer().on("drag", function(t) {
                        t.pageX = t.gesture.center.pageX,
                        t.pageY = t.gesture.center.pageY,
                        o.movezoom(t),
                ...
                function n() {
                    2 == i ? (o.closezoom(),
                    s.fancybox.open(o.gallery().cgallery)) : o.closezoom(),
                    i = 0
                }
                o.eventclick = function(t) {
                    t.hammer().on("tap", function() {
                        1 == ++i && setTimeout(n, 300),
        ...
        s(".xzoom5").each(function() {
            ...
            s(this).hammer().on("tap", function(e) {
                ...
                function i() {
                    if (2 == n) {
                        o.closezoom();
                        var t, e = o.gallery().cgallery, i = new Array;
                        for (t in e)
                            i[t] = {
                                src: e[t]
                            };
        ...
        })) : (s("#xzoom-fancy").bind("click", function(t) {
            var e = s(this).data("xzoom");
            e.closezoom(),
            s.fancybox.open(e.gallery().cgallery, {
                padding: 0,
                helpers: {
                    overlay: {
                        locked: !1
        ...
        s("#xzoom-magnific").bind("click", function(t) {
            var e = s(this).data("xzoom");
            e.closezoom();
            var i, n = e.gallery().cgallery, o = new Array;
            for (i in n)
                o[i] = {
                    src: n[i]
                };
